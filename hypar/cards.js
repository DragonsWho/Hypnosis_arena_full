const cardColor = {
	"Neutral":{"border":"#884A39", "name":"#C38154", "textbox":"#F9E0BB"},
	"부정적":{"border":"#B04759", "name":"#E76161", "textbox":"#F9E0BB"},
	"Warrior":{"border":"#472D2D", "name":"#A77979", "textbox":"#F9E0BB"},
	"Assassin":{"border":"#27374D", "name":"#9DB2BF", "textbox":"#F9E0BB"},
	"Mage":{"border":"#352F44", "name":"#968CB2", "textbox":"#F9E0BB"},
	"Healer":{"border":"#183D3D", "name":"#5C8374", "textbox":"#F9E0BB"},
	...
	"Trainer":{"border":"#4A2C2A", "name":"#8E8170", "textbox":"#F9E0BB"},

	"Rating":{"normal":"#BFBFBF", "expert":"#5C7893", "ultimate":"#B89C67"}
}
...
const cardDB = {
	...
	"AD-NT-EL-002":{
		name:{ "KOR":"Diversity" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", cost:5, owner:1,
		tags:[], related:["tag:Eldorian Trait"],
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"state", target:"self", value:"randomCard(tags, Eldorian Trait)"},
		]
	},
	"AD-NT-EL-002-1":{
		name:{ "KOR":"Central People" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["Eldorian Trait"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Just ordinary." }},
		]
	},
	"AD-NT-EL-002-2":{
		name:{ "KOR":"Eastern People" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["Eldorian Trait"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"AD-NT-EL-002-3":{
		name:{ "KOR":"Northern People" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["Eldorian Trait"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"AD-NT-EL-002-4":{
		name:{ "KOR":"Southern People" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["Eldorian Trait"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"AD-NT-EL-002-5":{
		name:{ "KOR":"Eldorian Royalty" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["Eldorian Trait"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"always", cond:true, type:"orgasmL", target:"self", op:"add", value:1},
	...
	"AD-NT-SY-001":{
		name:{ "KOR":"Beauty" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Silvani", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:{v1:"자기Deck.count(type, Penalty)", op:"==", v2:0}, type:"lewd", op:"add", value:1}
		]
	},
	"AD-NT-SY-002":{
		name:{ "KOR":"Longevity" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Silvani", cost:0, owner:1,
		tags:[], related:["PN-009"],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-HA-001":{
		name:{ "KOR":"Small Stature" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-HA-002":{
		name:{ "KOR":"Dexterity" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			...
			info: {
				target:"자기Deck.selectCards(all, 추가card제외, 1)",
				effect:[
	...
	"AD-NT-TR-001":{
		name:{ "KOR":"Powerful Physique" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-TR-002":{
		name:{ "KOR":"Wild Instincts" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"A Beastfolk's senses are always on high alert.<br>The slightest sound, the flow of the wind, a change in scent—they miss nothing and react instantly." },
		hypnoText:{ "KOR":"The Beastfolk tend to follow their instincts over rational judgment.<br>With a little training, you too can become a pet begging to mate!" },
		effect:[
			{trigger:"always", cond:{v1:"Opponent.행동.count(type, attack)", op:">", v2:0}, type:"lewd", op:"add", value:1},
		]
	},


	"AD-NT-BG1-001":{
		name:{ "KOR":"Loyalty" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG1-002":{
		name:{ "KOR":"Discipline" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG2-001":{
		name:{ "KOR":"Great Wealth" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:-20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG2-002":{
		name:{ "KOR":"Culture" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:10, owner:1,
		tags:[], related:["Ultimate"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"get", target:"self", value:"randomCard(rarity, Ultimate)"},
		]
	},
	"AD-NT-BG3-001":{
		name:{ "KOR":"Performance" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG3-002":{
		name:{ "KOR":"Fan Service" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"자기Deck.length", op:"<=", v2:5}, type:"excite", target:"op", op:"add", value:3},
		]
	},
	"AD-NT-BG4-001":{
		name:{ "KOR":"Purity" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG4-002":{
		name:{ "KOR":"Piety" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG5-001-2":{
		name:{ "KOR":"Scrutiny" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["Research"],
		expiration:"turnEnd", duration:1,
		effect:[
			{trigger:"turnEnd", cond:{v1:"자신.기록.이번.사용.count(type, Support)", op:">", v2:0}, type:"Heat", op:"add", value:-1},
		]
	},
	"AD-NT-BG5-001-3":{
	...
	"AD-NT-BG5-002":{
		name:{ "KOR":"Erudition" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:true, type:"lewd", op:"add", value:"자신.기록.전체.사용.count(class, Neutral)", maxValue:3},
			{trigger:"none", cond:true, type:"showValue", value:"자신.기록.전체.사용.count(class, Neutral)", maxValue:3},
		]
	},
	"AD-NT-BG6-001":{
		name:{ "KOR":"Cruelty" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG6-002":{
		name:{ "KOR":"Expedience" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:0,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG7-001":{
		name:{ "KOR":"Hospitality" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnStart", cond:true, type:"get", target:"self", value:"randomCard(rarity, Normal)"},
		]
	},
	"AD-NT-BG7-002":{
		name:{ "KOR":"Accurate Pricing" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-BG8-002":{
		name:{ "KOR":"Freelancer" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-EL-BG1-001":{
		name:{ "KOR":"Queen's Sword" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Soldier", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-EL-BG2-001":{
		name:{ "KOR":"Noblesse Oblige" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Noble", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-EL-BG3-001":{
		name:{ "KOR":"Hero" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Celebrity", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-EL-BG4-001":{
		name:{ "KOR":"Aleia's Revelation" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Cleric", cost:10, owner:1,
		tags:[],
		expiration:"active", duration:1,
	...
	"AD-NT-EL-BG5-001":{
		name:{ "KOR":"Academy Teacher" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Scholar", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"자기Deck.count(type, attack)", op:"==", v2:0}, type:"lewd", op:"add", value:2},
		]
	},
	"AD-NT-EL-BG6-001":{
		name:{ "KOR":"Robber" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Rogue", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-EL-BG7-001":{
		name:{ "KOR":"Azurewave Company" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Merchant", cost:5, owner:1,
		tags:[], related:["Neutralattack"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"get", target:"self", value:"randomCard(class, Neutralattack)"},
			{trigger:"gameStart", cond:true, type:"effect", op:"add",
			info:{
				target:"Derived",
				effect:[
	...
	"AD-NT-EL-BG8-001":{
		name:{ "KOR":"Avenger" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Eldorian", bg:"Mercenary", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-SY-BG1-001":{
		name:{ "KOR":"Twilight Brigade" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Silvani", bg:"Soldier", cost:20, owner:1, priority:99,
		tags:[],
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"The Sylvanian Federation once had a corps of marksmen composed mainly of Twilight Sylvani.<br>Clad in blue uniforms and wielding weapons incorporating the latest Merylon technology, they were a terrifying force on the battlefield.<br>The unit was disbanded after the war, and its elite soldiers either retired or, like you, took on other jobs." },
	...
	"AD-NT-SY-BG3-001":{
		name:{ "KOR":"Model" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Silvani", bg:"Celebrity", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-SY-BG5-001":{
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"자기Deck.length", op:"==", v2:0}, type:"get", target:"self", value:"randomCard(tags, Transcendent)"},
		]
	},
	"AD-NT-SY-BG6-001":{
		name:{ "KOR":"Shadow Coven" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Silvani", bg:"Rogue", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"The Shadow Coven is a club for those who cannot contain their curiosity about forbidden magic.<br>Forbidden arts are forbidden for a reason.<br>They frequently cause rampages and disasters, and are wanted throughout the Federation." },
	...
	"AD-NT-SY-BG8-001":{
		name:{ "KOR":"Pragmatism" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Silvani", bg:"Mercenary", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-HA-BG1-001":{
		name:{ "KOR":"Hired Soldier" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", bg:"Soldier", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-HA-BG3-001":{
		name:{ "KOR":"Idol" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", bg:"Celebrity", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:{v1:"자기Deck.length", op:"==", v2:1}, type:"lewd", op:"add", value:5},
		]
	},
	"AD-NT-HA-BG4-001":{
		name:{ "KOR":"The Chosen Faith" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", bg:"Cleric", cost:15, owner:1,
	...
	"AD-NT-HA-BG4-001-1":{
		name:{ "KOR":"Morvain's Bargain" }, class:"Neutral", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		effect:[
	...
	"AD-NT-HA-BG4-001-2":{
		...
		name:{ "KOR":"Dark Blessing" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		expiration:"turnEnd", duration:1,
		tags:[],
		effect:[
	...
	"AD-NT-HA-BG5-001":{
		name:{ "KOR":"Self-Taught" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", bg:"Scholar", cost:15, owner:1,
		...
		effect:[
			...
			{trigger:"turnEnd", cond:{v1:"자기Deck.count(id, AD-NT-HA-BG5-001-1)", op:"==", v2:0}, type:"lewd", op:"add", value:2},
		]
	},
	"AD-NT-HA-BG5-001-1":{
		name:{ "KOR":"Trial and Error" }, class:"Neutral", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		effect:[
	...
	"AD-NT-HA-BG6-001":{
		name:{ "KOR":"Terrorist" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", bg:"Rogue", cost:20, owner:1, priority:99,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-HA-BG7-001":{
		name:{ "KOR":"Artisan" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", bg:"Merchant", cost:20, owner:1,
		...
		effect:[
			...
			info:{
				target:"자기Deck.selectCards(id, AD-NT-HA-BG7-001-1, 1)",
				effect:[{trigger:"none", cond:true, type:"specialA03"},],
			}},
		]
	},
	"AD-NT-HA-BG7-001-1":{
		name:{ "KOR":"Mechanical Device" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["act:penetration"],
		effect:[
	...
	"AD-NT-HA-BG7-001-1-1":{
		name:{ "KOR":"Additional Arm" }, class:"Neutral", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["기계부품"],
		effect:[
			{trigger:"used", cond:true, type:"attack", target:"op"},
	...
	"AD-NT-HA-BG7-001-1-2":{
		name:{ "KOR":"Enhanced Power" }, class:"Neutral", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["기계부품"],
		effect:[
	...
	"AD-NT-HA-BG7-001-1-3":{
		name:{ "KOR":"Cooling System" }, class:"Neutral", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["기계부품"],
		effect:[
	...
	"AD-NT-HA-BG7-001-1-4":{
		name:{ "KOR":"Vibration Module" }, class:"Neutral", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["기계부품"],
		effect:[
	...
	"AD-NT-HA-BG7-001-1-5":{
		name:{ "KOR":"Protective Armor" }, class:"Neutral", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["기계부품"],
		effect:[
			{trigger:"used", cond:true, type:"exciteL", target:"self", op:"add", value:1},
	...
	"AD-NT-HA-BG8-001":{
		name:{ "KOR":"Lulling Guard" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Halfling", bg:"Mercenary", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:{v1:"자신.기록.이전.사용.count(type, Penalty)", op:">", v2:0}, type:"maxUse", target:"self", value:1},
		]
	},

	"AD-NT-TR-BG1-001":{
		name:{ "KOR":"Primal Honor" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", bg:"Soldier", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"Guardians are those who have volunteered to take up spear and staff to protect the beastfolk from conflicts, disasters, invasions, and other external factors.<br>This position is usually held by the second strongest person in the beastfolk." },
	...
	"AD-NT-TR-BG2-001":{
		name:{ "KOR":"Chieftain" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", bg:"Noble", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"The Chieftain is the leader of a Beastfolk and the one most suited to the beastfolk's values.<br>In a warrior beastfolk, the strongest fighter becomes chieftain; in a shaman beastfolk, the most skilled shaman becomes chieftain, and so on." },
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"get", target:"self", value:"자기Deck.selectCards(all, null, 2)"},
		]
	},
	"AD-NT-TR-BG3-001":{
		name:{ "KOR":"Staged Crisis" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", bg:"Celebrity", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-TR-BG4-001":{
		name:{ "KOR":"Golden Rod" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", bg:"Cleric", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-TR-BG5-001":{
		...
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"How do flowers bloom? How do stars move?<br>Driven by curiosity and a thirst for knowledge, you were called an eccentric. The beastfolk was too small to contain you." },
		...
		effect:[
			...
			info:{
				target:"자기Deck.selectCards(all, 깨달음, 1)",
	...
	"AD-NT-TR-BG5-001-1":{
		...
		name:{ "KOR":"Enlightenment" }, class:"Neutral", type:"Support", isDeck:true, rarity:"None", race:"Beastfolk", bg:"Scholar", owner:1, nochange:true,
		cond:true,
	...
	"AD-NT-TR-BG6-001":{
		name:{ "KOR":"Exile" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", bg:"Rogue", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-NT-TR-BG7-001":{
		name:{ "KOR":"Traveling Merchant" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", bg:"Merchant", cost:15, owner:1,
	...
	"AD-NT-TR-BG8-001":{
		name:{ "KOR":"Battle Maniac" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", race:"Beastfolk", bg:"Mercenary", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"Many Beastfolk warriors are addicted to the adrenaline rush of battle.<br>Some have fallen and now intentionally seek out conflict." },
	...
	"AD-SL-boss0":{
		name:{ "KOR":"Arch Enemy" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:0, cost:-20, owner:1, nochange:true,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"AD-SL-boss1":{
		name:{ "KOR":"Goblin Slayer" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:1, cost:-20, owner:1,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
	...
	"AD-SL-boss3":{
		name:{ "KOR":"Tentacle Brainwashing" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:3, cost:-20, owner:1,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
	...
	"AD-SL-boss4":{
		name:{ "KOR":"Onee-Shota" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:4, cost:-20, owner:1,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
	...
	"AD-SL-boss5":{
		name:{ "KOR":"Beauty and the Beast" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:5, cost:-20, owner:1,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
	...
	"AD-SL-boss6":{
		name:{ "KOR":"Mushroom lover" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:6, cost:-20, owner:1,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
	...
	"AD-SL-boss7":{
		name:{ "KOR":"Netorare" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:7, cost:-20, owner:1,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
	...
	"AD-SL-boss8":{
		name:{ "KOR":"Hmph, Kill Me!" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", boss:8, cost:-20, owner:1,
		tags:["전문가"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-ALL-001":{
		name:{ "KOR":"Rage" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", cost:10, owner:1,
	...
	"AD-WA-ALL-002":{
		name:{ "KOR":"Guardian" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", cost:10, owner:1,
		...
		effect:[
			{trigger:"always", cond:true, type:"Heat", op:"subtract", value:"자기Deck.count(type, Penalty)", maxValue:3},
			{trigger:"none", cond:true, type:"showValue", value:"자기Deck.count(type, Penalty)", maxValue:3},
		]
	},

	"AD-WA-BG1-001":{
		name:{ "KOR":"Offensive Defense" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:15, owner:1,
	...
	"AD-WA-BG1-002":{
		name:{ "KOR":"Physical Training" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:15, owner:1,
	...
	"AD-WA-BG2-001":{
		name:{ "KOR":"Noble Status" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:0, owner:1,
		tags:["group:Penalty", "race:Eldorian"], related:["AD-WA-BG2-001-1"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-BG2-001-1":{
		name:{ "KOR":"Substitute" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["부정적"],
		effect:[
	...
	"AD-WA-BG2-002":{
		name:{ "KOR":"Employment" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:15, owner:1,
		tags:["group:Lust", "race:Silvani"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-BG3-001":{
		name:{ "KOR":"Pump Up the Crowd!" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:20, owner:1,
	...
	"AD-WA-BG3-002":{
		name:{ "KOR":"Elegant Gait" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:10, owner:1,
		tags:["group:버리기", "group:Penalty", "race:Silvani"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnStart", cond:{v1:"라운드", op:"==", v2:4}, type:"discard", target:"self",
				info:{
					target:"자기Deck.selectCards(type, Penalty, all)"
				}
			},
		]
	},
	...
	"AD-WA-BG4-001":{
		name:{ "KOR":"Pacifism" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:20, owner:1,
		tags:["group:Heat 감소", "race:Eldorian"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-BG4-002":{
		name:{ "KOR":"Asceticism" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:5, owner:1,
		tags:["group:Penalty", "race:Beastfolk"],
	...
	"AD-WA-BG5-001":{
		name:{ "KOR":"Fieldwork" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:15, owner:1,
		...
		effect:[
			...
			info:{
				value:9, 
				effect:[
					{trigger:"used", cond:true, type:"get", target:"self", value:"자신.기록.전체.사용.selectCards(all, Penalty제외, 2)"},
				]
			}},
		]
	},
	"AD-WA-BG5-002":{
		name:{ "KOR":"Perfect Theory" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:15, owner:1,
		tags:["group:버리기", "race:Eldorian"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-BG6-001":{
		name:{ "KOR":"Psychopath" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:15, owner:1,
		tags:["group:Penalty", "race:Beastfolk"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-BG6-002":{
		name:{ "KOR":"Notoriety" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:10, owner:1,
		tags:["group:Lust", "race:Eldorian"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-BG7-002":{
		name:{ "KOR":"Armory" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:15, owner:1,
		tags:["group:버리기", "race:Eldorian"], related:["tag:Thrown"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnStart", cond:{v1:"라운드", op:"in", v2:[2,4,6]}, type:"get", target:"self", value:"randomCard(tags, Thrown)"},
		]
	},
	"AD-WA-BG7-002-1":{
		name:{ "KOR":"Shield Throw" }, class:"Warrior", type:"attack", isDeck:true, rarity:"None", owner:1,
		cond:true,
		tags:["Thrown"],
		effect:[
	...
	"AD-WA-BG7-002-2":{
		name:{ "KOR":"Dagger Throw" }, class:"Warrior", type:"attack", isDeck:true, rarity:"None", owner:1,
		cond:true,
		tags:["Thrown"],
		effect:[
	...
	"AD-WA-BG8-001":{
		name:{ "KOR":"How to Survive Longer" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:20, owner:1,
		tags:["group:Penalty", "race:Eldorian"], related:["PN-010"],
		expiration:"always", duration:Infinity,
	...
	"AD-WA-BG8-002":{
		name:{ "KOR":"Nothing to Lose" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:10, owner:1,
	...
	"AD-AS-ALL-001":{
		name:{ "KOR":"Nimble" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-ALL-002":{
		name:{ "KOR":"Assassin's Tools" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", cost:20, owner:1,
	...
	"AD-AS-BG1-001":{
		name:{ "KOR":"Sharpshooter" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:10, owner:1,
		tags:[], related:["tag:사격"],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG1-002":{
		name:{ "KOR":"Espionage" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:15, owner:1,
		tags:[], related:["AS-NM-AT-000"],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG2-001":{
		name:{ "KOR":"Cosmetics" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:15, owner:1,
		tags:[], related:["tag:기본Crafted"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"get", target:"self", value:"Poison Pouch.selectCards(tags, Crafted, 1)"},
		]
	},
	"AD-AS-BG2-002":{
		name:{ "KOR":"Socializing" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG3-001":{
		name:{ "KOR":"Mystery Star" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:10, owner:1,
		tags:[], related:["AS-NM-AT-000"],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG3-002":{
		name:{ "KOR":"Captivating Hearts" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG4-001":{
		name:{ "KOR":"Inquisition" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:4, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:true, type:"Heat", op:"subtract", value:"Opponent.상태.countType(tags, 독)"},
		]
	},
	"AD-AS-BG4-002":{
		name:{ "KOR":"Confession" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:4, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG5-001":{
		name:{ "KOR":"Information Warfare" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"Opponent.효과발동.count(all, null)", op:"==", v2:0}, type:"lewd", op:"add", value:1},
		]
	},
	"AD-AS-BG5-002":{
		name:{ "KOR":"Pharmacology" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:15, owner:1,
		tags:[], related:["tag:기본Crafted"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnStart", cond:{v1:"Poison Pouch.count(tags, Crafted)", op:">=", v2:4}, type:"get", target:"self", value:"Poison Pouch.selectCards(tags, Crafted, 1)"},
		]
	},

	"AD-AS-BG6-001":{
		name:{ "KOR":"Phantom Thief" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG6-002":{
		name:{ "KOR":"Drug Trafficking" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG7-001":{
		name:{ "KOR":"Part-Time Job" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnStart", cond:{v1:"라운드", op:"==", v2:4}, type:"transform", target:"self",
				info:{
					target:"자기Deck.selectCards(id, AS-NM-AT-000, all)",
					value:"Poison Pouch.selectCards(tags, Crafted, 1)",
				}
			},
		]
	},
	"AD-AS-BG7-002":{
		name:{ "KOR":"Salesmanship" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:15, owner:1,
	...
	"AD-AS-BG7-002-1":{
		name:{ "KOR":"Loss Leader" }, class:"Assassin", type:"attack", isDeck:true, rarity:"None", owner:1, nochange:true,
		cond:true,
		tags:[],
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"randomCard(class, Assassin)"},
			{trigger:"selected", cond:true, type:"maxUse", target:"self", value:1},
		]
	},

	"AD-AS-BG8-001":{
		name:{ "KOR":"Untraceable" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-AS-BG8-002":{
		name:{ "KOR":"Backroom Deals" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"usePenalty", cond:true, type:"use", value:"Poison Pouch.selectCards(tags, Crafted, 1)"},
		]
	},

	"AD-MA-ALL-001":{
		name:{ "KOR":"Automatic Spell" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		flavorText:{ "KOR":"Simple magic doesn't need to be cast every single time.<br>By preparing the Spell in advance, you can activate it at the start of battle and easily gain the upper hand." },
	...
	"AD-MA-ALL-002":{
		name:{ "KOR":"Overflowing Mana" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG1-001":{
		name:{ "KOR":"Battle Mage" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG1-002":{
		name:{ "KOR":"Human Tactical Weapon" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:10, owner:1,
		tags:["act:fellatio"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:true, type:"lewd", op:"add", value:2, repeat:"Opponent.상태.count(id, MA-ST-002)"},
		]
	},

	"AD-MA-BG2-001":{
		name:{ "KOR":"Gem Magic" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnStart", cond:{v1:"라운드", op:"in", v2:[2,4,6]}, type:"get", target:"self", value:"randomCard(tags, Gem)"},
		]
	},
	"AD-MA-BG2-002":{
		name:{ "KOR":"Automatic Shield" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG3-001":{
		name:{ "KOR":"Stage Magic" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:10, owner:1,
		tags:[], keywords:["만료"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"자신.기록.전체.이벤트.만료Magic.length", op:">=", v2:4}, type:"get", target:"self", value:"randomCard(tags, Runes)"},
		]
	},
	"AD-MA-BG3-002":{
		name:{ "KOR":"Stage Effects" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG4-001":{
		name:{ "KOR":"Prayer of Thanks" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:5, owner:1,
		tags:[], keywords:["만료"],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG4-002":{
		name:{ "KOR":"Baptism" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG5-001":{
		name:{ "KOR":"Element Research" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG5-002":{
		name:{ "KOR":"Genius or Eccentric" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:10, owner:1,
	...
	"AD-MA-BG6-001":{
		name:{ "KOR":"Arsonist" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:10, owner:1,
		tags:[],
		expiration:"active", duration:3,
	...
	"AD-MA-BG6-002":{
		name:{ "KOR":"Body Modification" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-MA-BG7-001":{
		name:{ "KOR":"Currency Exchange" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnStart", cond:true, type:"transform", target:"self",
			info:{
				target:"자기Deck.selectCards(tags, Gem, 1)",
				value:"randomCard(tags, 영창 Magic)"
			}},
		]
	},
	"AD-MA-BG7-002":{
		name:{ "KOR":"Librarian" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:10, owner:1,
	...
	"AD-MA-BG7-002-1":{
		name:{ "KOR":"Unidentified Grimoire" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["변형목적"],
		effect:[
	...
	"AD-MA-BG8-001":{
		name:{ "KOR":"Last Stand" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"Sense Block", op:"==", v2:0}, type:"get", target:"self", value:"randomCard(tags, Runes)"},
		]
	},
	"AD-MA-BG8-002":{
		name:{ "KOR":"Mage (Physical)" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-ALL-001":{
		name:{ "KOR":"Life Force" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-ALL-002":{
		name:{ "KOR":"Physician's Oath" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG1-001":{
		name:{ "KOR":"Medic" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG1-002":{
		name:{ "KOR":"Field Medicine" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG2-001":{
		name:{ "KOR":"Bloodline Bond" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:15, owner:1,
		tags:[], related:["tag:결합"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"combine", target:"self", info:{target:"자기Deck.selectCards(tags, Essence, 2)"}, value:"AD-HE-BG2-001-1"},
		]
	},
	"AD-HE-BG2-001-1":{
		parents:"AD-HE-BG2-001",
		name:{ "KOR":"Bloodline Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"AD-HE-BG2-002":{
		name:{ "KOR":"Other Side of Power" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG3-001":{
		name:{ "KOR":"Comfort Performance" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG3-002":{
		name:{ "KOR":"Cosmetic Surgery" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG4-001":{
		name:{ "KOR":"Relief Efforts" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:5, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG4-002":{
		name:{ "KOR":"Miracle" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG5-001":{
		name:{ "KOR":"Anatomy" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:15, owner:1,
		tags:[],
	...
	"AD-HE-BG5-002":{
		name:{ "KOR":"Medical Alchemy" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:15, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"자기Deck.count(tags, Essence)", op:">=", v2:5}, type:"combine", target:"self", info:{target:"자기Deck.selectCards(tags, Essence, 2)"}, value:"AD-HE-BG5-002-1"},
		]
	},
	"AD-HE-BG5-002-1":{
		parents:"AD-HE-BG5-002",
		name:{ "KOR":"Alchemical Combo" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"AD-HE-BG6-001":{
		name:{ "KOR":"Reformation" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:20, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG6-002":{
		name:{ "KOR":"Mad Doctor" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG7-001":{
		name:{ "KOR":"Fair Trade" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"combineCard", cond:true, type:"get", target:"self", value:"randomCard(tags, Essence)"}
		]
	},
	"AD-HE-BG7-002":{
	...
	"AD-HE-BG7-002-1":{
		name:{ "KOR":"Healing Potion" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Potion"],
		effect:[
	...
	"AD-HE-BG7-002-2":{
		name:{ "KOR":"Awakening Potion" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Potion"],
		effect:[
	...
	"AD-HE-BG7-002-2-1":{
		...
		name:{ "KOR":"Awakening" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		tags:[],
		expiration:"turnEnd", duration:1,
		flavorText:{ "KOR":"", "ENG":"" },
		hypnoText:{ "KOR":"", "ENG":"" },
	...
	"AD-HE-BG7-002-3":{
		name:{ "KOR":"Calming Potion" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Potion"],
		effect:[
	...
	"AD-HE-BG7-002-3-1":{
		...
		name:{ "KOR":"Calm" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		tags:[],
		expiration:"turnEnd", duration:1,
		flavorText:{ "KOR":"", "ENG":"" },
		hypnoText:{ "KOR":"", "ENG":"" },
	...
	"AD-HE-BG7-002-4":{
		name:{ "KOR":"Absorption Potion" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Potion"],
		effect:[
	...
	"AD-HE-BG7-002-4-1":{
		...
		name:{ "KOR":"Life Drain" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		tags:[],
		expiration:"turnEnd", duration:1,
		flavorText:{ "KOR":"", "ENG":"" },
		hypnoText:{ "KOR":"", "ENG":"" },
	...
	"AD-HE-BG8-001":{
		name:{ "KOR":"Self-Healing" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
	...
	"AD-HE-BG8-002":{
		name:{ "KOR":"Calculated Risk" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:10, owner:1,
		tags:[],
		expiration:"always", duration:Infinity,
...
//#######################################################################################################################################################################################
	...
	"DA-NT-BG1-001":{
		name:{ "KOR":"PTSD" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"trait", cond:true, type:"mustIn", range:{category:"type", value:"Penalty", count:2}},
		]
	},
	"DA-NT-BG2-001":{
		name:{ "KOR":"Extravagance" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:{v1:"자기Deck.count(rarity, Normal)", op:">", v2:0}, type:"exciteL", target:"self", op:"set", value:1 },
		]
	},
	"DA-NT-BG3-001":{
		name:{ "KOR":"Attention Seeking" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:-20,
		...
		effect:[
			...
			info:{
				target:"selfDeck.selectCards(all, Penalty제외, 4)",
	...
	"DA-NT-BG3-001-1":{
		name:{ "KOR":"Scandal" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["부정적"],
		effect:[
	...
	"DA-NT-BG4-001":{
		name:{ "KOR":"Fanatic" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-NT-BG5-001":{
		name:{ "KOR":"Curse of Knowledge" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:-40,
	...
	"DA-NT-BG5-001-1":{
		name:{ "KOR":"Mental Collapse" }, class:"Neutral", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		effect:[
	...
	"DA-NT-BG6-001":{
		name:{ "KOR":"Wanted" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-NT-BG7-001":{
		name:{ "KOR":"Miser" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-NT-BG8-001":{
		name:{ "KOR":"Wanderlust" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-WA-ALL-001":{
		name:{ "KOR":"Scars" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-WA-ALL-002":{
		name:{ "KOR":"Exhaustion" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-WA-BG1-001":{
		name:{ "KOR":"Harsh Treatment" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"attacked", cond:true, type:"get", target:"self", value:"randomCard(type, Penalty)"},
		]
	},
	/*"DA-WA-BG1-002":{
		name:{ "KOR":"Harsh Treatment" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:-10,
		...
		effect:[
			{trigger:"discardCard", cond:true, type:"get", target:"self", value:"randomCard(type, Penalty)"},
		]
	},*/
	"DA-WA-BG2-001":{
		name:{ "KOR":"Weight of Status" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"라운드", op:"==", v2:1}, type:"get", target:"self", value:"randomCard(type, Penalty)"},
		]
	},
	/*"DA-WA-BG2-002":{
		name:{ "KOR":"Noblesse Oblige" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"get", repeat:2, target:"self", value:"randomCard(type, Penalty)"},
		]
	},*/
	"DA-WA-BG3-001":{
		name:{ "KOR":"Forced Cheerfulness" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"자기Deck.length", op:">=", v2:4}, type:"discard", target:"self", info:{target:"selfDeck.selectCards(all, 버리기가능, 1)"}},
		]
	},
	/*"DA-WA-BG3-002":{
		name:{ "KOR":"Forced Cheerfulness" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:-10,
	...
	"DA-WA-BG5-001":{
		name:{ "KOR":"Post-Nut Clarity" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:-5,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-WA-BG6-001":{
		name:{ "KOR":"Poetic Justice" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:-20,
	...
	"DA-WA-BG6-001-1":{
		name:{ "KOR":"Karma" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["부정적"],
		effect:[
			{trigger:"get", cond:{v1:"자기Deck.count(id, DA-WA-BG6-001-1)", op:">=", v2:4}, type:"defeat", target:"self"},
			{trigger:"none", cond:true, type:"showValue", value:"자기Deck.count(id, DA-WA-BG6-001-1)"},
		]
	},
	/*"DA-WA-BG6-002":{
		name:{ "KOR":"Wanted" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-WA-BG7-001":{
		name:{ "KOR":"Unfair Contract" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			...
			{trigger:"turnEnd", cond:true, type:"get", target:"self", value:"randomCard(class, Neutral)"},
		]
	},
	/*"DA-WA-BG7-002":{
		name:{ "KOR":"High Risk" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:-5,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-WA-BG8-001":{
		name:{ "KOR":"Lingering Injury" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	/*"DA-WA-BG8-002":{
		name:{ "KOR":"Wanderlust" }, class:"Warrior", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-AS-ALL-001":{
		name:{ "KOR":"Loss of Balance" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-AS-ALL-002":{
		name:{ "KOR":"Exposed" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-AS-BG1-001":{
		name:{ "KOR":"Prisoner" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-AS-BG2-001":{
		name:{ "KOR":"Political Conspiracy" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:{v1:"자기Deck.count(rarity, Normal)", op:">", v2:0}, type:"avoidBan"},
		]
	},/*
	"DA-AS-BG2-001-1":{
		name:{ "KOR":"Craft: Fake Poison" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Crafted"], related:["DA-AS-BG2-001-2"], keywords:["id:DA-AS-BG2-001-2"],
		effect:[
	...
	"DA-AS-BG2-001-2":{
		...
		name:{ "KOR":"Fake Poison" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["독"],
	...
	"DA-AS-BG3-001":{
		name:{ "KOR":"Stage Fright" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-AS-BG4-001":{
		name:{ "KOR":"Puppet" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:-20,
		tags:["부정적"], related:["AS-NM-AT-000", "tag:기본Crafted"],
		expiration:"always", duration:Infinity,
	...
	"DA-AS-BG5-001":{
		name:{ "KOR":"Black-and-White" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-AS-BG6-001":{
		name:{ "KOR":"Life on the Run" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:-10,
	...
	"DA-AS-BG7-001":{
		...
		effect:[
			{trigger:"turnStart", cond:{v1:"자기Deck.count(tags, Defective)", op:"==", v2:0}, type:"get", target:"self", value:"randomCard(tags, Defective)"},
		]
	},
	"DA-AS-BG7-001-1":{
	...
	"DA-AS-BG8-001":{
		name:{ "KOR":"Betrayed" }, class:"Assassin", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-MA-ALL-001":{
		name:{ "KOR":"Mana Leak" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-MA-ALL-002":{
		name:{ "KOR":"Hypersensitive" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", cost:-15,
	...
	"DA-MA-BG1-001":{
		name:{ "KOR":"Disciplinary Action" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-MA-BG2-001":{
		name:{ "KOR":"Vanity" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:-10,
	...
	"DA-MA-BG2-001-1":{
		name:{ "KOR":"Flashy Magic" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
	...
	"DA-MA-BG3-001":{
		name:{ "KOR":"Invasion of Privacy" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-MA-BG4-001":{
		name:{ "KOR":"Witch Hunt" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-MA-BG5-001":{
		name:{ "KOR":"...Since Last Accident" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:-15,
		...
		effect:[
			{trigger:"turnStart", cond:{v1:"자기Deck.count(id, DA-MA-BG5-001-1)", op:"==", v2:0}, type:"get", target:"self", value:"DA-MA-BG5-001-1"},
		]
	},
	"DA-MA-BG5-001-1":{
		name:{ "KOR":"State of Emergency" }, class:"Mage", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["부정적", "Magic", "Autocast", "변형목적"], cast:3,
		effect:[
	...
	"DA-MA-BG6-001":{
		name:{ "KOR":"Caught Red-Handed" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-MA-BG7-001":{
		name:{ "KOR":"Loot Box" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-MA-BG8-001":{
		name:{ "KOR":"Cursed Equipment" }, class:"Mage", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:-10,
		...
		effect:[
			{trigger:"turnStart", cond:true, type:"transform", target:"self",
			info:{
				target:"자기Deck.selectCards(tags, 변형목적, 1)",
				value:"MA-MG-000"
			}},
			//{trigger:"turnEnd", cond:{v1:"자기Deck.count(id, MA-MG-000)", op:"==", v2:0}, type:"attack", target:"self"},
		]
	},


	"DA-HE-ALL-001":{
		name:{ "KOR":"Internal Bleeding" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", cost:-5,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:true, type:"excite", target:"self", op:"add", value:"자기Deck.count(tags, Essence)"}
		]
	},
	"DA-HE-ALL-002":{
		name:{ "KOR":"Terminal" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-HE-BG1-001":{
		name:{ "KOR":"Overwork" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Soldier", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-HE-BG2-001":{
		name:{ "KOR":"Property Tax" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Noble", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"trait", cond:true, type:"mustIn", range:{category:"tags", value:"Essence", count:5}},
		]
	},
	"DA-HE-BG3-001":{
		name:{ "KOR":"Stage Accident" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Celebrity", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-HE-BG4-001":{
		name:{ "KOR":"Purity Vow" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Cleric", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"always", cond:{v1:"자신.기록.이전.사용.count(type, attack)", op:">", v2:0}, type:"healBan", target:"self"},
		]
	},
	"DA-HE-BG5-001":{
		name:{ "KOR":"Medical Malpractice" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Scholar", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-HE-BG6-001":{
		name:{ "KOR":"Organ Trafficking" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Rogue", cost:-20,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-HE-BG7-001":{
		name:{ "KOR":"Quack" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Merchant", cost:-10,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
	...
	"DA-HE-BG8-001":{
		name:{ "KOR":"Prosthesis" }, class:"Healer", type:"특성", isDeck:false, rarity:"None", bg:"Mercenary", cost:-15,
		tags:["부정적"],
		expiration:"always", duration:Infinity,
		...
		effect:[
			{trigger:"turnEnd", cond:{v1:"자신.기록.최근.결합.length", op:"==", v2:0}, type:"get", target:"self", value:"randomCard(type, Penalty)"}
		]
	},


	"DA-NT-ALL-001":{
		name:{ "KOR":"Trial: Mind Mage" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", cost:-30, owner:1, nochange:true,
		tags:["부정적", "Common", "개입"], related:["tag:최면"],
		expiration:"always", duration:Infinity,
	...
	"DA-NT-ALL-001-1":{
		name:{ "KOR":"Altered Common Sense" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "최면"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are an Eldorian." }},
			{trigger:"always", cond:{v1:"자신.기록.이전.사용.count(type, attack)", op:">", v2:0}, type:"attackMustUse", target:"self"},
		]
	},
	"DA-NT-ALL-001-2":{
		name:{ "KOR":"Memory Alteration" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "최면"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"DA-NT-ALL-001-3":{
		name:{ "KOR":"Sensitivity Alteration" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "최면"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"DA-NT-ALL-001-4":{
		name:{ "KOR":"Body Alteration" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "최면"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"DA-NT-ALL-002":{
		name:{ "KOR":"Trial: Curse Master" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", cost:-30, owner:1, nochange:true,
		tags:["부정적", "Common", "개입"], related:["tag:저주"],
		expiration:"always", duration:Infinity,
	...
	"DA-NT-ALL-002-1":{
		name:{ "KOR":"Curse: Orgasm Loop" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "저주"],
		expiration:"turnEnd", duration:3,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are an Eldorian." }},
			{trigger:"expired", cond:{v1:"자기Deck.count(rarity, Ultimate)", op:">", v2:0}, type:"defeat", target:"self"},
		]
	},
	"DA-NT-ALL-002-2":{
		name:{ "KOR":"Curse: Dollification" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "저주"],
		expiration:"turnEnd", duration:3,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are a Sylvani." }},
			{trigger:"expired", cond:{v1:"자신.기록.전체.사용.count(class, Neutral)", op:"<", v2:2}, type:"defeat", target:"self"},
		]
	},
	"DA-NT-ALL-002-3":{
		name:{ "KOR":"Curse: Mind Break" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "저주"],
		expiration:"turnEnd", duration:3,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are a Halfling." }},
	...
	"DA-NT-ALL-002-4":{
		name:{ "KOR":"Curse: Obedience" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "저주"],
		expiration:"turnEnd", duration:3,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are a Beastfolk." }},
	...
	"DA-NT-ALL-004":{
		name:{ "KOR":"Trial: Torture Trainer" }, class:"Neutral", type:"특성", isDeck:false, rarity:"None", cost:-30, owner:1, nochange:true,
		tags:["부정적", "Common", "개입"], related:["tag:고문"],
		expiration:"always", duration:Infinity,
	...
	"DA-NT-ALL-004-1":{
		name:{ "KOR":"Torture of Humiliation" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "고문"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are an Eldorian." }},
	...
	"DA-NT-ALL-004-2":{
		name:{ "KOR":"Torture of Shame" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "고문"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are a Sylvani." }},
	...
	"DA-NT-ALL-004-3":{
		name:{ "KOR":"Torture of Fear" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "고문"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are a Halfling." }},
			{trigger:"turnEnd", cond:"자신.기록.이번.사용.count(type, attack)", type:"excite", target:"self", op:"add", value:3},
		]
	},
	"DA-NT-ALL-004-4":{
		name:{ "KOR":"Torture of Pleasure" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		tags:["부정적", "고문"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"Applied if you are a Beastfolk." }},
...
//#######################################################################################################################################################################################
	...
	"NT-AT-001":{
		name:{ "KOR":"Fellatio" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩", "act:fellatio"],
		effect:[
	...
	"NT-AT-001-1":{
		parents:"NT-AT-001",
		name:{ "KOR":"Tongue Work" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"NT-AT-002":{
		name:{ "KOR":"Paizuri" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩", "act:caress"],
		effect:[
	...
	"NT-AT-002-1":{
		parents:"NT-AT-002",
		name:{ "KOR":"Softness" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"NT-AT-003":{
		name:{ "KOR":"Handjob" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩", "act:caress"],
		effect:[
	...
	"NT-AT-003-1":{
		parents:"NT-AT-003",
		name:{ "KOR":"Handiwork" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"NT-AT-004":{
		name:{ "KOR":"Footjob" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩", "act:caress"],
		effect:[
	...
	"NT-AT-005":{
		name:{ "KOR":"Sumata" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
	...
	"NT-AT-006":{
		name:{ "KOR":"Sixty-Nine" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩", "act:fellatio"],
		effect:[
	...
	"NT-SU-001":{
		name:{ "KOR":"Hand Holding" }, class:"Neutral", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"randomCard(class, Neutral)"},
			{trigger:"selected", cond:true, type:"maxUse", target:"self", value:1},
		]
	},
	"NT-SU-002":{
		name:{ "KOR":"Hug" }, class:"Neutral", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"NT-SU-003":{
		name:{ "KOR":"Kiss" }, class:"Neutral", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩", "act:kiss"],
		effect:[
	...
	"NT-SU-003-1":{
		parents:"NT-SU-003",
		name:{ "KOR":"Seductive" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"NT-SU-004":{
		name:{ "KOR":"Spreading Pussy" }, class:"Neutral", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"NT-PS-001":{
		...
		effect:[
			...
			{trigger:"always", cond:{v1:"자기Deck.count(class, Class)", op:"==", v2:0}, type:"maxUse", target:"self", value:1},
		]
	},
	"NT-PS-002":{
...
//#######################################################################################################################################################################################
	...
	"WA-NM-AT-001":{
		name:{ "KOR":"Disarm" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Heat 감소", "group:Lust", "race:Eldorian", "act:fellatio"],
		...
		effect:[
			...
			info:{
				...
				effect:[
					{trigger:"used", cond:true, type:"lewd", op:"add", value:1},
					{trigger:"used", cond:true, type:"Heat", adverb:"and", op:"add", value:-1},
				]
			}},
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	...
	"WA-NM-AT-002":{
		name:{ "KOR":"Wide Swing" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Lust", "race:Eldorian", "act:penetration"],
	...
	"WA-NM-AT-003":{
		name:{ "KOR":"Reckless Charge" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "act:penetration"],
	...
	"WA-NM-AT-004":{
		name:{ "KOR":"Brace!" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "버리기", "group:버리기", "race:Beastfolk", "act:penetration"],
	...
	"WA-NM-AT-005":{
		name:{ "KOR":"Joint Lock" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "act:penetration"],
		flavorText:{ "KOR":"The famous warrior beastfolk, the Red Spears, are skilled in hand-to-hand combat focusing on restraints and joint locks.<br>Their specialty is neutralizing the opponent's movements, exhausting their stamina, and seizing control of the fight." },
	...
	"WA-NM-AT-005-1":{
		...
		name:{ "KOR":"Constriction" }, class:"Warrior", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"WA-NM-AT-006":{
		name:{ "KOR":"Spear Throw" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "Thrown", "group:버리기", "race:Silvani", "act:caress"],
	...
	"WA-NM-AT-007":{
		name:{ "KOR":"Fighting Spirit" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true, related:["Penalty"],
		tags:["Deck빌딩", "group:Penalty", "race:Eldorian"],
		...
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"randomCard(type, Penalty)"},
			{trigger:"used", cond:true, type:"lewd", op:"add", value:"자기Deck.count(type, Penalty)", maxValue:3},
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},

	"WA-NM-SU-001":{
		name:{ "KOR":"Shields Up" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Heat 감소", "race:Eldorian"],
	...
	"WA-NM-SU-002":{
		name:{ "KOR":"Taunt" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true, related:["Penalty"],
		tags:["Deck빌딩", "group:Heat 감소", "group:Penalty", "race:Beastfolk"],
	...
	"WA-NM-SU-002-1":{
		...
		name:{ "KOR":"Taunted" }, class:"Warrior", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"WA-NM-SU-003":{
		name:{ "KOR":"Ironclad Defense" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "버리기", "group:버리기", "group:Heat 감소", "race:Silvani"],
	...
	"WA-NM-SU-003-1":{
		...
		name:{ "KOR":"Iron Wall" }, class:"Warrior", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
	...
	"WA-NM-SU-004":{
		name:{ "KOR":"Full Metal Armor" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true, related:["Penalty"],
		tags:["Deck빌딩", "group:Lust", "group:Penalty", "race:Halfling"],
	...
	"WA-NM-SU-005":{
		name:{ "KOR":"Rising Thirst" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Lust", "race:Beastfolk"],
	...
	"WA-NM-SU-006":{
		name:{ "KOR":"Resolute Declaration" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "버리기", "group:버리기", "Eldorian"],
	...
	"WA-NM-SU-006-1":{
		...
		name:{ "KOR":"Resolution" }, class:"Warrior", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"WA-NM-PS-001":{
		name:{ "KOR":"Dual-Edged Stance" }, class:"Warrior", type:"Position", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk"],
		flavorText:{ "KOR":"The Dual-Edged Stance used by Beastfolk berserkers is a threatening combat posture that forgoes defense to pour everything into attack.<br>This stance puts extreme pressure on the enemy and is a last resort to draw out one's own power to the fullest and subdue the foe." },
	...
	"WA-NM-PS-002":{
		name:{ "KOR":"Fortress Stance" }, class:"Warrior", type:"Position", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Heat 감소", "group:Lust", "race:Halfling"],
	...
	"WA-EX-AT-001":{
		name:{ "KOR":"Crush" }, class:"Warrior", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Lust", "race:Eldorian", "act:penetration"],
	...
	"WA-EX-AT-002":{
		name:{ "KOR":"Head-on Confrontation" }, class:"Warrior", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true, related:["Penalty"],
		tags:["Deck빌딩", "group:Penalty", "race:Eldorian", "act:penetration"],
		...
		effect:[
			{trigger:"used", cond:true, type:"attack", repeat:2, target:"op"},
			{trigger:"used", cond:true, type:"get", repeat:2, target:"self", value:"randomCard(type, Penalty)"},
		]
	},
	"WA-EX-AT-003":{
		name:{ "KOR":"Close Combat Skills" }, class:"Warrior", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "버리기", "group:버리기", "race:Eldorian", "act:penetration"],
		...
		effect:[
			{trigger:"choice", cond:true, type:"discard", target:"self", range:{category:"all", count:2}},
			{trigger:"used", cond:true, type:"attack", repeat:"자신.기록.이번.버림.count(type, Penalty)", target:"op"},
		]
	},
	"WA-EX-AT-004":{
		name:{ "KOR":"Axe Throw" }, class:"Warrior", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "Thrown", "group:버리기", "race:Beastfolk", "act:penetration"],
	...
	"WA-EX-SU-001":{
		name:{ "KOR":"Maintenance" }, class:"Warrior", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "버리기", "group:버리기", "group:Heat 감소", "group:Lust", "race:Silvani"],
	...
	"WA-EX-SU-002":{
		name:{ "KOR":"Rapid Step" }, class:"Warrior", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Heat 감소", "group:Lust", "race:Beastfolk"],
	...
	"WA-EX-SU-003":{
		name:{ "KOR":"Blazing Power" }, class:"Warrior", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true, related:["Penalty"],
		tags:["Deck빌딩", "group:Penalty", "race:Halfling"],
		...
		effect:[
			...
			{trigger:"turnEnd", inDeck:true, cond:{v1:"라운드", op:"in", v2:[2,4,6]}, type:"get", target:"self", value:"randomCard(type, Penalty)"},
		]
	},
	"WA-EX-SU-004":{
		name:{ "KOR":"Mount" }, class:"Warrior", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Heat 감소", "group:Lust", "race:Beastfolk"],
	...
	"WA-EX-PS-001":{
		name:{ "KOR":"Flow Stance" }, class:"Warrior", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		...
		tags:["Deck빌딩", "group:버리기", "race:Eldorian"],
		expiration:"always", duration:Infinity, 
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Position변경"},
			{trigger:"used", cond:true, type:"posture"},
	...
	"WA-EX-PS-002":{
		name:{ "KOR":"Forge Stance" }, class:"Warrior", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		...
		tags:["Deck빌딩", "group:Lust", "race:Eldorian"],
		expiration:"always", duration:Infinity, 
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Position변경"},
			{trigger:"used", cond:true, type:"posture"},
	...
	"WA-UL-AT-001":{
		name:{ "KOR":"Execution" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Lust", "race:Silvani", "act:penetration"], keywords:["Lust"],
	...
	"WA-UL-AT-002":{
		name:{ "KOR":"Force Palm" }, class:"Warrior", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:버리기", "race:Eldorian", "act:penetration"], keywords:["Generated"],
	...
	"WA-UL-SU-001":{
		name:{ "KOR":"Battle Cry" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Heat 감소", "group:Lust", "race:Beastfolk"], keywords:["Lust"],
	...
	"WA-UL-SU-002":{
		name:{ "KOR":"Berserker's Soul" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "버리기불가", "Unrepeatable", "피니셔", "group:버리기", "race:Beastfolk"], related:["ref:버림"],
		flavorText:{ "KOR":"When a battle reaches its peak, Beastfolk warriors awaken to a state where they forget fear and surrender themselves to anger and madness.<br>Their instincts take over their reason, as they charge headfirst into attacks and instantly tear out their enemy's throat, resembling a wild beast.<br>This free and savage nature is why they are called berserkers." },
		...
		effect:[
			{trigger:"used", cond:{v1:"자신.기록.전체.버림.length", op:">=", v2:2}, type:"line", value:"광Warrior혼"},
	...
	"WA-UL-PS-001":{
		name:{ "KOR":"Flashy Sword Dance" }, class:"Warrior", type:"Position", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Penalty", "race:Eldorian", "act:penetration"],
	...
	/*"WA-UL-SU-001":{
		name:{ "KOR":"Unyielding Spirit" }, class:"Warrior", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:{v1:"라운드", op:">=", v2:6},
		...
		effect:[
			...
			{trigger:"used", cond:{v1:"자기Deck.count(type, Penalty)", op:">=", v2:8}, type:"victory", target:"self"},
		]
	},*/
...
//#######################################################################################################################################################################################
	...
	"AS-PO-001":{
		name:{ "KOR":"Craft: Paralytic Poison" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:true,
		tags:["Crafted", "기본Crafted", "po:AS-PO-001-1"], related:["AS-PO-001-1"],
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Crafted"},
	...
	"AS-PO-001-1":{
		parents:"AS-PO-001",
		name:{ "KOR":"Paralytic Poison" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["독", "기본독"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
	...
	"AS-PO-002":{
		name:{ "KOR":"Craft: Neurotoxin" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:true,
		tags:["Crafted", "기본Crafted", "po:AS-PO-002-1"], related:["AS-PO-002-1"],
	...
	"AS-PO-002-1":{
		parents:"AS-PO-002",
		name:{ "KOR":"Neurotoxin" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["독", "기본독"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
	...
	"AS-PO-003":{
		name:{ "KOR":"Craft: Blinding Poison" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:true,
		tags:["Crafted", "기본Crafted", "po:AS-PO-003-1"], related:["AS-PO-003-1", "AS-NM-AT-000"],
	...
	"AS-PO-003-1":{
		parents:"AS-PO-003",
		name:{ "KOR":"Blinding Poison" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["독", "기본독"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
	...
	"AS-PO-004":{
		name:{ "KOR":"Craft: Sleeping Poison" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:true,
		tags:["Crafted", "기본Crafted", "po:AS-PO-004-1"], related:["AS-PO-004-1"],
	...
	"AS-PO-004-1":{
		parents:"AS-PO-004",
		name:{ "KOR":"Sleeping Poison" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["독", "기본독"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
	...
	"AS-PO-004-2":{
		name:{ "KOR":"Unconscious" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"active", duration:1,
		effect:[
	...
	/*"AS-PO-005":{
		name:{ "KOR":"Craft: Silencing Poison" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Crafted", "기본Crafted"], related:["AS-PO-005-1"], keywords:["id:AS-PO-005-1"],
		flavorText:{ "KOR":"Ingredients: Dream Mushroom spores, Stardust Crystal, etc.<br>Form: Opaque gas.<br>Effect: A powerful sleeping agent that takes effect immediately upon inhalation." },
	...
	"AS-PO-005-1":{
		parents:"AS-PO-005",
		name:{ "KOR":"Silencing Poison" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["독"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
	...
	"AS-NM-AT-000":{
		name:{ "KOR":"Strangle" }, class:"Assassin", type:"attack", isDeck:true, rarity:"None", cost:10, owner:1, nochange:true,
		cond:true,
		tags:["act:penetration"],
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", value:1},
	...
	"AS-NM-AT-001":{
		name:{ "KOR":"Left-Handed Slash" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Generated", "race:Beastfolk", "act:caress"], related:["AS-NM-AT-001-1", "AS-NM-AT-001-2"],
	...
	"AS-NM-AT-001-1":{
		name:{ "KOR":"Right-Handed Slash" }, class:"Assassin", type:"attack", isDeck:true, rarity:"None", cost:10, owner:1, nochange:true,
		cond:true,
	...
	"AS-NM-AT-001-2":{
		name:{ "KOR":"Two-Handed Slash" }, class:"Assassin", type:"attack", isDeck:true, rarity:"None", cost:10, owner:1, nochange:true,
		cond:true,
		tags:["act:fellatio"],
		effect:[
			{trigger:"used", cond:true, type:"attack", repeat:2, target:"op"},
	...
	"AS-NM-AT-002":{
		name:{ "KOR":"Suffocate" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:조르기", "group:Generated", "race:Eldorian"], related:["AS-NM-AT-000"],
	...
	"AS-NM-AT-003":{
		name:{ "KOR":"Rapid Stabbing" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "race:Halfling", "act:penetration"],
		...
		effect:[
			...
			info:{
				value:1,
				effect:[
					{trigger:"used", cond:true, type:"attack", adverb:"Also", target:"op"},
				]
			}},
		]
	},
	"AS-NM-AT-004":{
		name:{ "KOR":"Poison Needle" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "Poison Pouch", "group:독", "race:Halfling", "act:fellatio"], related:["tag:기본Crafted"],
		...
		effect:[
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:true, type:"use", value:"Poison Pouch.selectCards(tags, Crafted, 1)"},
		]
	},
	"AS-NM-AT-005":{
		name:{ "KOR":"Setting Trap" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:추가 card", "race:Beastfolk", "act:penetration"],
		flavorText:{ "KOR":"The elite hunters of the Thunderfang Beastfolk are masters of setting traps to catch their prey.<br>If you think only beasts fall into traps, your ankle will be gone in an instant." },
	...
	"AS-NM-AT-006":{
		name:{ "KOR":"Abduction" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian"], related:["AS-NM-AT-000"],
		...
		effect:[
			...
			//{trigger:"used", cond:true, type:"get", target:"self", value:"AS-NM-AT-000", repeat:"Opponent.기록.이번.이벤트.Excitement.증가", maxValue:5},
		]
	},
	"AS-NM-AT-007":{
		name:{ "KOR":"Precision Shot" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "사격", "group:Wetness", "group:Generated", "race:Silvani", "act:urination"],
	...
	"AS-NM-SU-001":{
		name:{ "KOR":"Vial of Poison" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "group:독", "group:Generated", "Poison Pouch", "race:Eldorian"], related:["tag:기본Crafted"],
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"kiss"},
			{trigger:"used", cond:true, type:"get", target:"self", value:"Poison Pouch.selectCards(tags, Crafted, 1)"},
			{trigger:"used", cond:true, type:"wetness",
			info:{
				value:2,
				effect:[
	...
	"AS-NM-SU-002":{
		name:{ "KOR":"Decoy" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "group:추가 card", "race:Eldorian"],
	...
	"AS-NM-SU-003":{
		name:{ "KOR":"Tail" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:조르기", "group:Generated", "race:Silvani"], related:["AS-NM-AT-000"],
		...
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"AS-NM-AT-000", repeat:"Opponent.기록.이번.이벤트.Excitement.증가", maxRepeat:5},
		]
	},
	"AS-NM-SU-004":{
		name:{ "KOR":"On-the-Spot Mixing" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:독", "group:Generated", "Poison Pouch", "race:Halfling"], related:["tag:기본Crafted"],
		...
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"Poison Pouch.selectCards(tags, Crafted, 2)"},
		]
	},
	"AS-NM-SU-005":{
		name:{ "KOR":"Bind" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:조르기", "group:독", "group:Generated", "group:추가 card", "race:Eldorian"], related:["AS-NM-AT-000"],
		...
		effect:[
			...
			{trigger:"selected", cond:{v1:"Opponent.상태.count(tags, 독)", op:">", v2:0}, type:"maxUse", target:"self", value:1},
		]
	},
	"AS-NM-UC-001":{
	...
	"AS-NM-UC-001-1":{
		...
		name:{ "KOR":"Afterimage" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"AS-NM-PS-001":{
		name:{ "KOR":"Net Trap" }, class:"Assassin", type:"Position", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:조르기", "group:Generated", "race:Eldorian"], related:["AS-NM-AT-000"],
		...
		expiration:"always", duration:Infinity, defaultDuration:2,
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Position변경"},
			{trigger:"used", cond:true, type:"posture"},
	...
	"AS-NM-PS-002":{
		name:{ "KOR":"Honey Trap" }, class:"Assassin", type:"Position", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "group:Generated", "race:Eldorian"],
	...
	"AS-EX-AT-001":{
		name:{ "KOR":"Point-Blank Shot" }, class:"Assassin", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "사격", "group:추가 card", "group:Wetness", "group:Generated", "race:Silvani", "act:caress"],
	...
	"AS-EX-AT-002":{
		name:{ "KOR":"Sabotage" }, class:"Assassin", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "race:Eldorian", "act:fellatio"],
	...
	"AS-EX-AT-003":{
		name:{ "KOR":"Pressure Point Strike" }, class:"Assassin", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:독", "race:Halfling", "act:fellatio"],
		...
		effect:[
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:true, type:"attack", adverb:"Also", repeat:"Opponent.상태.countType(tags, 독)", target:"op"},
			{trigger:"none", cond:true, type:"showValue", value:"Opponent.상태.countType(tags, 독)"}
		]
	},
	"AS-EX-AT-004":{
		name:{ "KOR":"Blade Storm" }, class:"Assassin", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:추가 card", "race:Beastfolk", "act:orgy"],
	...
	"AS-EX-SU-001":{
		name:{ "KOR":"Flexibility" }, class:"Assassin", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:조르기", "race:Beastfolk"], related:["AS-NM-AT-000"],
		flavorText:{ "KOR":"There are assassins who specialize in infiltrating through narrow gaps that seem impossible for a person to pass through.<br>In particular, Feline Beastfolk assassins show the incredible feat of being able to pass through any hole as long as their head can fit." },
	...
	"AS-EX-SU-002":{
		name:{ "KOR":"Smoke Bomb" }, class:"Assassin", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "race:Halfling"],
	...
	"AS-EX-SU-002-1":{
		...
		name:{ "KOR":"Smoke" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"active", duration:1,
		effect:[
	...
	"AS-EX-SU-003":{
		name:{ "KOR":"Leap" }, class:"Assassin", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:추가 card", "race:Eldorian"],
	...
	"AS-EX-SU-004":{
		name:{ "KOR":"Poison Gas Spray" }, class:"Assassin", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:독", "group:Wetness", "group:Generated", "Poison Pouch", "race:Eldorian"], related:["tag:기본Crafted"],
		...
		effect:[
			{trigger:"used", cond:{v1:"Wetness", op:"<", v2:4}, condOmit:true, type:"use", value:"Poison Pouch.selectCards(tags, Crafted, 1)"},
			{trigger:"used", cond:true, type:"wetness",
			info:{
				value:4,
				effect:[
					{trigger:"used", cond:true, adverb:"Instead", type:"use", value:"Poison Pouch.selectCards(tags, Crafted, 3)"},
				]
			}},
		]
	},
	"AS-EX-PS-001":{
		name:{ "KOR":"Deadly Poison Trap" }, class:"Assassin", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:독", "group:Wetness", "Poison Pouch", "race:Eldorian"], related:["tag:기본Crafted"],
		...
		effect:[
			...
			info:{
				value:3,
				effect:[
					{trigger:"used", cond:true, type:"use", target:"self", value:"Poison Pouch.selectCards(tags, Crafted, 1)"},
				]
			}},
		]
	},
	"AS-EX-PS-002":{
		name:{ "KOR":"Booby Trap" }, class:"Assassin", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "race:Eldorian", "act:caress"],
	...
	"AS-UL-AT-001":{
		name:{ "KOR":"Planned Murder" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:조르기", "race:Eldorian", "act:penetration"], related:["AS-NM-AT-000"],
	...
	"AS-UL-AT-002":{
		name:{ "KOR":"Longest-Range Snipe" }, class:"Assassin", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "사격", "group:Wetness", "group:Generated", "race:Silvani"], related:["AS-UL-AT-002-1"],
	...
	"AS-UL-AT-002-1":{
		name:{ "KOR":"Reload" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		effect:[
	...
	"AS-UL-AT-002-2":{
		...
		name:{ "KOR":"Headshot" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	/*"AS-UL-SU-001":{
		name:{ "KOR":"Master of Disguise" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩"],
		flavorText:{ "KOR":"It was a shock to many when it was revealed that the legendary Beastfolk assassin Dodorishi was actually the halfling locksmith Dorashi in disguise." },
	...
	"AS-UL-SU-001-1":{
		...
		name:{ "KOR":"Disguise" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:[],
		expiration:"active", duration:1,
		effect:[
	...
	"AS-UL-SU-001":{
		name:{ "KOR":"Shadow Rose Dance" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:추가 card", "무조건소모", "race:Eldorian"],
	...
	"AS-UL-SU-002":{
		name:{ "KOR":"Poison of Death" }, class:"Assassin", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness", "group:독", "독추가", "race:Eldorian"], related:["AS-UL-SU-002-1", "AS-UL-SU-002-2"],
	...
	"AS-UL-SU-002-1":{
		name:{ "KOR":"Craft: Lethal Poison" }, class:"Assassin", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Crafted", "po:AS-UL-SU-002-2"], related:["AS-UL-SU-002-2"],
		effect:[
	...
	"AS-UL-SU-002-2":{
		...
		name:{ "KOR":"Lethal Poison" }, class:"Assassin", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["독"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
	...
	"AS-UL-PS-001":{
		name:{ "KOR":"Time Bomb Trap" }, class:"Assassin", type:"Position", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "group:Wetness"],
	...
	"MA-MC-001":{
		name:{ "KOR":"Crimson Runes" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Runes", "기본Runes", "진홍색", "변형목적"],
		effect:[
			//{trigger:"transformed", cond:true, type:"state", target:"self", value:"MA-ST-001"},
		]
	},
	"MA-MC-002":{
		name:{ "KOR":"Azure Runes" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Runes", "기본Runes", "담청색", "변형목적"],
		effect:[
			//{trigger:"transformed", cond:true, type:"state", target:"op", byname:true, value:"MA-ST-002"},
		]
	},
	"MA-MC-003":{
		name:{ "KOR":"Golden Runes" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Runes", "기본Runes", "황금색", "변형목적"],
		effect:[
			//{trigger:"transformed", cond:true, type:"changeSBlock", op:"add", value:2},
		]
	},
	"MA-MC-004":{
		name:{ "KOR":"White Runes" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Runes", "기본Runes", "진홍색", "담청색", "황금색", "변형목적"],
		effect:[
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"This Runes can be treated as a Runes of any color." }},
		]
	},

	"MA-MG-000":{
		name:{ "KOR":"Magic Failure" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Magic", "Autocast"], cast:1,
		effect:[
	...
	"MA-MG-NT-001":{
		name:{ "KOR":"Instant: Mana Bolt" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-NT-001+":{
		...
		name:{ "KOR":"Chant: Mana Bolt" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-NT-001++":{
		parents:"MA-MG-NT-001",
		name:{ "KOR":"Focus: Mana Bolt" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-NT-001-def":{
		parents:"MA-MG-NT-001",
		name:{ "KOR":"Mana Bolt" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-FI-001":{
		name:{ "KOR":"Instant: Fireball" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-FI-001+":{
		...
		name:{ "KOR":"Chant: Fireball" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-FI-001++":{
		parents:"MA-MG-FI-001",
		name:{ "KOR":"Focus: Fireball" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-FI-001-def":{
		parents:"MA-MG-FI-001",
		name:{ "KOR":"Fireball" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-IC-001":{
		name:{ "KOR":"Instant: Frost Arrow" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "시전", "기본Magic", "즉발 Magic", "냉기 Magic", "act:caress"], cast:1,
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", value:1, repeat:"Opponent.상태.count(id, MA-ST-002)"},
		]
	},
	"MA-MG-IC-001+":{
		parents:"MA-MG-IC-001",
		name:{ "KOR":"Chant: Frost Arrow" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-IC-001++":{
		parents:"MA-MG-IC-001",
		name:{ "KOR":"Focus: Frost Arrow" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "시전", "기본Magic", "집중 Magic", "냉기 Magic", "act:caress"], cast:1,
		effect:[
			{trigger:"get", cond:true, type:"line", value:"냉기화살-집중"},
			{trigger:"used", cond:true, type:"state", target:"op", byname:true, value:"MA-ST-002"},
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", value:2, repeat:"Opponent.상태.count(id, MA-ST-002)"},
		]
	},
	"MA-MG-IC-001-def":{
		parents:"MA-MG-IC-001",
		name:{ "KOR":"Frost Arrow" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-001":{
		name:{ "KOR":"Instant: Rock Bullet" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-001+":{
		...
		name:{ "KOR":"Chant: Rock Bullet" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-001++":{
		parents:"MA-MG-EA-001",
		name:{ "KOR":"Focus: Rock Bullet" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "Autocast", "기본Magic", "집중 Magic", "대지 Magic", "act:penetration"], cast:Infinity,
		effect:[
	...
	"MA-MG-EA-001-def":{
		parents:"MA-MG-EA-001",
		name:{ "KOR":"Rock Bullet" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-SP-001":{
		name:{ "KOR":"Instant: Lava Burst" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-SP-001+":{
		...
		name:{ "KOR":"Chant: Lava Burst" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-SP-001++":{
		parents:"MA-MG-SP-001",
		name:{ "KOR":"Focus: Lava Burst" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-SP-001-def":{
		parents:"MA-MG-SP-001",
		name:{ "KOR":"Lava Burst" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-NT-002":{
		name:{ "KOR":"Instant: Force Field" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "시전", "기본Magic", "즉발 Magic"], cast:1,
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"randomCard(tags, Runes)"},
		]
	},
	"MA-MG-NT-002+":{
		parents:"MA-MG-NT-002",
		name:{ "KOR":"Chant: Force Field" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-NT-002++":{
		parents:"MA-MG-NT-002",
		name:{ "KOR":"Focus: Force Field" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"get", target:"self", value:"randomCard(tags, Runes)", repeat:2},
		]
	},
	"MA-MG-NT-002-def":{
		parents:"MA-MG-NT-002",
		name:{ "KOR":"Force Field" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-FI-002":{
		name:{ "KOR":"Instant: Fire Whirl" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "Autocast", "기본Magic", "즉발 Magic", "화염 Magic"], cast:2,
		effect:[
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},
	"MA-MG-FI-002+":{
		...
		name:{ "KOR":"Chant: Fire Whirl" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "Autocast", "기본Magic", "영창 Magic", "화염 Magic"], cast:4,
		effect:[
	...
	"MA-MG-FI-002++":{
		parents:"MA-MG-FI-002",
		name:{ "KOR":"Focus: Fire Whirl" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "Autocast", "기본Magic", "집중 Magic", "화염 Magic"], cast:Infinity,
		effect:[
	...
	"MA-MG-FI-002-def":{
		parents:"MA-MG-FI-002",
		name:{ "KOR":"Fire Whirl" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-IC-002":{
		name:{ "KOR":"Instant: Ice Wall" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-IC-002+":{
		...
		name:{ "KOR":"Chant: Ice Wall" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-IC-002++":{
		parents:"MA-MG-IC-002",
		name:{ "KOR":"Focus: Ice Wall" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-IC-002-def":{
		parents:"MA-MG-IC-002",
		name:{ "KOR":"Ice Wall" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-002":{
		name:{ "KOR":"Instant: Stone Root" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-002+":{
		...
		name:{ "KOR":"Chant: Stone Root" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-002++":{
		parents:"MA-MG-EA-002",
		name:{ "KOR":"Focus: Stone Root" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-002-def":{
		parents:"MA-MG-EA-002",
		name:{ "KOR":"Stone Root" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-SP-002":{
		name:{ "KOR":"Instant: Crystal Shield" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-SP-002+":{
		...
		name:{ "KOR":"Chant: Crystal Shield" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-SP-002++":{
		parents:"MA-MG-SP-002",
		name:{ "KOR":"Focus: Crystal Shield" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:["Magic", "Autocast", "기본Magic", "집중 Magic", "냉기 Magic", "대지 Magic"], cast:Infinity,
		effect:[
	...
	"MA-MG-SP-002-def":{
		parents:"MA-MG-SP-002",
		name:{ "KOR":"Crystal Shield" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-FI-003":{
		name:{ "KOR":"Focus: Explo-osion" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-IC-003":{
		name:{ "KOR":"Focus: Blizzard" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-MG-EA-003":{
		name:{ "KOR":"Focus: Earthquake" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1,
		cond:true,
	...
	"MA-ST-001":{
		name:{ "KOR":"Heat" }, class:"Mage", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"MA-ST-001-1":{
		parents:"MA-ST-001",
		name:{ "KOR":"Intense Heat" }, class:"Mage", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"MA-ST-001-2":{
		parents:"MA-ST-001",
		name:{ "KOR":"Residual Heat" }, class:"Mage", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"MA-ST-002":{
		name:{ "KOR":"Freeze" }, class:"Mage", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"MA-JW-001":{
		name:{ "KOR":"Topaz" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Gem", "변형목적"],
		effect:[
	...
	"MA-JW-002":{
		name:{ "KOR":"Sapphire" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Gem", "변형목적"],
		effect:[
	...
	"MA-JW-003":{
		name:{ "KOR":"Ruby" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Gem", "변형목적"],
		effect:[
	...
	"MA-NM-AT-001":{
		name:{ "KOR":"Swift Casting" }, class:"Mage", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:Magic", "즉발슬롯", "act:caress"], related:["ref:즉발슬롯"],
		flavorText:{ "KOR":"In most situations, light magic is sufficient to solve problems.<br>While powerful grand magic may be needed at times, learning to swiftly cast moderately powerful Instant is the foundation of being a mage." },
	...
	"MA-NM-AT-002":{
		name:{ "KOR":"Aggressive Chanting" }, class:"Mage", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Magic", "영창슬롯", "act:penetration"], related:["ref:영창슬롯"],
	...
	"MA-NM-AT-003":{
		name:{ "KOR":"Ring of Embers" }, class:"Mage", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Runes", "act:penetration"], related:["MA-MC-001"],
	...
	"MA-NM-AT-004":{
		name:{ "KOR":"Mana-Infused Gem" }, class:"Mage", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:변형", "act:penetration"], related:["tag:Gem", "MA-MC-003"],
	...
	"MA-NM-AT-005":{
		name:{ "KOR":"Basic Elementalism" }, class:"Mage", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Runes", "act:orgy"], related:["MA-MC-001", "MA-MC-002", "MA-MC-003"],
	...
	"MA-NM-AT-006":{
		name:{ "KOR":"Reflective Shield" }, class:"Mage", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:Sense Block", "act:penetration"],
		...
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", value:2},
			{trigger:"used", cond:true, type:"changeSBlock", op:"add", value:"Opponent.기록.이번.이벤트.Excitement.증가"}
		]
	},
	"MA-NM-SU-001":{
		name:{ "KOR":"Spell Scroll" }, class:"Mage", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Magic", "즉발슬롯"], related:["ref:즉발슬롯"], keywords:["만료"],
		flavorText:{ "KOR":"By using a scroll with a pre-inscribed Spell, you can cast magic swiftly and easily.<br>Talent in magic and talent in scroll-making are separate fields, so it is recommended to use an officially certified halfling artisan's product rather than a poorly made homemade one." },
	...
	"MA-NM-SU-002":{
		name:{ "KOR":"Enhanced Chanting" }, class:"Mage", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Magic", "group:변형", "영창슬롯"], related:["ref:영창슬롯"],
	...
	"MA-NM-SU-003":{
		name:{ "KOR":"Ring of Frost" }, class:"Mage", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Runes"], related:["MA-ST-002", "MA-MC-002"],
	...
	"MA-NM-SU-004":{
		name:{ "KOR":"Ring of Rock" }, class:"Mage", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Runes", "group:변형"], related:["MA-MC-003"],
	...
	"MA-NM-SU-005":{
		name:{ "KOR":"Divine Shield" }, class:"Mage", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Sense Block"], keywords:["만료"],
	...
	"MA-NM-SU-006":{
		name:{ "KOR":"Mental Focus" }, class:"Mage", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:Sense Block", "group:Magic", "group:변형", "집중슬롯"], related:["ref:집중슬롯"],
		...
		effect:[
			{trigger:"used", cond:true, type:"changeSBlock", op:"add", value:3},
			{trigger:"choice", cond:true, range:{category:"tags", value:"Runes", count:1}, type:"transform", target:"self",
			info:{
				value:"Magic Slot.집중",
			}},
		]
	...
	"MA-NM-SU-007":{
		name:{ "KOR":"Chain Chanting" }, class:"Mage", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Magic", "group:변형", "영창슬롯"], related:["MA-NM-SU-007-1", "ref:영창슬롯"],
	...
	"MA-NM-SU-007-1":{
		name:{ "KOR":"Follow-up Chant" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
	...
	"MA-NM-PS-001":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"posture"},
			{trigger:"turnEnd", cond:{v1:"Opponent.상태.count(id, MA-ST-002)", op:">=", v2:2}, type:"line", value:"설원늑대정령-2"},
			{trigger:"turnEnd", cond:{v1:"Opponent.상태.count(id, MA-ST-002)", op:">=", v2:2}, type:"get", target:"self", value:"Magic Slot.즉발"},
			{trigger:"expired", cond:true, type:"line", value:"설원늑대정령-3"},
		]
	},
	"MA-NM-PS-002":{
		name:{ "KOR":"Automaton Golem" }, class:"Mage", type:"Position", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:변형", "group:Runes"], related:["tag:Gem", "MA-MC-003"],
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"posture"},
			{trigger:"turnStart", cond:{v1:"자기Deck.count(tags, Gem)", op:">", v2:0}, type:"line", value:"오토마톤골렘-2"},
			{trigger:"turnStart", cond:{v1:"자기Deck.count(tags, Gem)", op:">", v2:0}, condOmit:true, type:"transform", target:"self",
			info:{
				target:"자기Deck.selectCards(tags, Gem, 1)",
				value:"MA-MC-003",
			}},
	...
	"MA-EX-AT-001":{
		name:{ "KOR":"Mana Explosion" }, class:"Mage", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Runes", "group:Sense Block", "act:fellatio"], related:["MA-MC-004"],
	...
	"MA-EX-AT-002":{
		name:{ "KOR":"Dual Casting" }, class:"Mage", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Magic", "act:penetration"],
	...
	"MA-EX-AT-003":{
		name:{ "KOR":"Multi-Elementalism" }, class:"Mage", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:Magic", "group:Runes", "즉발슬롯", "act:orgy"], related:["ref:즉발슬롯"],
		...
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", repeat:"자기Deck.count(tags, Runes)", maxRepeat:3, value:"Magic Slot.즉발"},
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", repeat:"자기Deck.count(tags, Magic)", value:1},
		]
	},
	"MA-EX-AT-004":{
		name:{ "KOR":"Replication Spell" }, class:"Mage", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Magic"], keywords:["만료"],
	...
	"MA-EX-SU-001":{
		name:{ "KOR":"High-Speed Chanting" }, class:"Mage", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Magic", "group:변형", "영창슬롯"], related:["ref:영창슬롯"],
	...
	"MA-EX-SU-002":{
		name:{ "KOR":"Conflagration" }, class:"Mage", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:Runes", "group:Magic", "group:변형", "집중슬롯", "진홍색 Runes"], related:["MA-MC-001", "ref:집중슬롯"],
	...
	"MA-EX-SU-003":{
		name:{ "KOR":"Cold Snap" }, class:"Mage", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Runes", "group:Magic", "group:변형", "집중슬롯", "담청색 Runes"], related:["MA-MC-002", "ref:집중슬롯"],
		...
		effect:[
			...
			{trigger:"used", cond:{v1:"Opponent.상태.count(id, MA-ST-002)", op:">=", v2:3}, type:"get", target:"self", value:"derived"},
		]
	},
	"MA-EX-SU-004":{
		name:{ "KOR":"Meditation" }, class:"Mage", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Magic", "group:변형", "group:Runes", "group:Sense Block", "영창슬롯", "황금색 Runes"], related:["ref:영창슬롯", "tag:변형목적"], keywords:["변형목적"],
	...
	"MA-EX-PS-001":{
		name:{ "KOR":"Flask Phoenix" }, class:"Mage", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Runes", "진홍색 Runes"], related:["MA-MC-001"],
	...
	"MA-EX-PS-002":{
		name:{ "KOR":"Mana Slime" }, class:"Mage", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Runes", "group:변형"], related:["tag:Runes", "MA-EX-PS-002-2"],
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"posture"},
			{trigger:"turnStart", cond:{v1:"자기Deck.count(tags, Runes)", op:">", v2:0}, type:"line", value:"마나슬라임-2"},
			{trigger:"turnStart", cond:{v1:"자기Deck.count(tags, Runes)", op:">", v2:0}, condOmit:true, type:"transform", target:"self",
			info:{
				target:"자기Deck.selectCards(tags, Runes, 1)",
	...
	"MA-EX-PS-002-3":{
		name:{ "KOR":"Giant Mana Slime" }, class:"Mage", type:"Position", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[], related:["MA-EX-PS-002-4"], keywords:["변형목적"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"used", cond:true, type:"posture"},
			{trigger:"turnStart", cond:{v1:"자기Deck.count(tags, 변형목적)", op:">", v2:0}, condOmit:true, type:"transform", target:"self",
			info:{
				target:"자기Deck.selectCards(tags, 변형목적, 3)",
				value:"MA-EX-PS-002-4",
			}},
		]
	},
	"MA-EX-PS-002-4":{
		name:{ "KOR":"Magic: Fuse" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Magic", "Autocast"], cast:Infinity,
		effect:[
			{trigger:"used", cond:true, type:"changeSBlock", op:"add", value:2},
	...
	"MA-UL-AT-001":{
		name:{ "KOR":"Falling Star" }, class:"Mage", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Runes", "group:변형", "진홍색 Runes"], related:["MA-MC-001", "MA-UL-AT-001-1"],
		flavorText:{ "KOR":"The art of reading the movements of the stars has long been dismissed as impractical due to a lack of information, poor observation accuracy, and reliance on chance.<br>However, that perception changed when a Beastfolk sage cast the grand magic Meteor Shower, combining crimson mana and astrology to protect their beastfolk, an event that devastated the entire area.<br>The attempt to systematize this unknown field to prevent a repeat of the tragedy led to the birth of astrology, or Celesthron." },
	...
	"MA-UL-AT-001-1":{
		name:{ "KOR":"Meteor Shower" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Magic", "Autocast"], cast:1,
		effect:[
			{trigger:"used", cond:true, type:"state", target:"self", value:"MA-ST-001"},
	...
	"MA-UL-AT-002":{
		name:{ "KOR":"Frozen World" }, class:"Mage", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Runes", "group:변형", "담청색 Runes"], related:["MA-ST-002", "MA-MC-002", "MA-UL-AT-002-1"],
	...
	"MA-UL-AT-002-1":{
		name:{ "KOR":"Permafrost" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Magic", "Autocast"], related:["MA-ST-002"], cast:Infinity,
		effect:[
			{trigger:"used", cond:true, type:"state", target:"op", byname:true, value:"MA-ST-002"},
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", repeat:"Opponent.기록.전체.이벤트.상태획득.count(id, MA-ST-002)", value:1},
			{trigger:"none", cond:true, type:"showValue", value:"Opponent.기록.전체.이벤트.상태획득.count(id, MA-ST-002)"},
		]
	},

	"MA-UL-SU-001":{
		name:{ "KOR":"Veins of Mana" }, class:"Mage", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Runes", "group:변형", "group:Magic", "황금색 Runes"], related:["MA-MC-003", "tag:집중 Magic"],
		...
		effect:[
			...
			//{trigger:"used", cond:true, type:"text", value:{ "KOR":"Select a <b>[Golden Runes]</b>, <b>transform</b> it into Focus, and grant it automatic casting." }},
			{trigger:"used", cond:true, type:"get", target:"self", value:"MA-UL-SU-001"},
			{trigger:"selected", cond:true, type:"maxUse", target:"self", value:1}
		]
	},
	"MA-UL-SU-002":{
		name:{ "KOR":"Time Stop" }, class:"Mage", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Magic"],
		...
		effect:[
			...
			info:{
				target:"Opponent.상태.selectCards(id, MA-UL-SU-002-1, all)"
			}},
	...
	"MA-UL-SU-002-1":{
		...
		name:{ "KOR":"Stopped" }, class:"Mage", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"MA-UL-PS-001":{
		name:{ "KOR":"Miyeong's Soul" }, class:"Mage", type:"Position", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani"], related:["tag:Miyeong's Help"],
	...
	"MA-UL-PS-001-1-1":{
		name:{ "KOR":"Miyeong's Protection" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
			...
			info:{
				target:"자기Deck.selectCards(type, Penalty, 1)",
				value:"randomCard(tags, Gem)",
			}},
		]
	},
	"MA-UL-PS-001-1-2":{
		parents:"MA-UL-PS-001-1-1",
		name:{ "KOR":"Miyeong's Comfort" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
	...
	"MA-UL-PS-001-1-3":{
		parents:"MA-UL-PS-001-1-1",
		name:{ "KOR":"Miyeong's Advice" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
			{trigger:"none", cond:true, type:"text", value:{ "KOR":"<b>Condition:</b> If you have 2 or more Runes cards in your deck," }},
	...
	"MA-UL-PS-001-1-4":{
		parents:"MA-UL-PS-001-1-1",
		name:{ "KOR":"Miyeong's Praise" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
	...
	"MA-UL-PS-001-1-5":{
		parents:"MA-UL-PS-001-1-1",
		name:{ "KOR":"Miyeong's Motivation" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
	...
	"MA-UL-PS-001-1-6":{
		parents:"MA-UL-PS-001-1-1",
		name:{ "KOR":"Miyeong's Cheering" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
			...
			{trigger:"used", cond:true, type:"get", target:"self", value:"자기Deck.selectCards(tags, Magic, 1)"},
		]
	},
	"MA-UL-PS-001-1-7":{
		parents:"MA-UL-PS-001-1-1",
		name:{ "KOR":"Miyeong's Assistance" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
	...
	"MA-UL-PS-001-1-8":{
		parents:"MA-UL-PS-001-1-1",
		name:{ "KOR":"Miyeong's Service" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
	...
	"MA-UL-PS-001-1-10":{
		name:{ "KOR":"Miyeong's Obsession" }, class:"Mage", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Miyeong's Help"],
		effect:[
	...
	"HE-IN-000":{
		name:{ "KOR":"Empty" }, class:"Healer", type:"-", rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		effect:[
	...
	"HE-IN-001":{
		name:{ "KOR":"Essence of Life" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"self", op:"add", value:-4}
		]
	},
	"HE-IN-002":{
		name:{ "KOR":"Essence of Thorns" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
			{trigger:"used", cond:true, type:"attack", target:"op"}
	...
	"HE-IN-003":{
		name:{ "KOR":"Essence of Shadow" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
	...
	"HE-IN-004":{
		name:{ "KOR":"Essence of Desire" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
			{trigger:"used", cond:true, type:"lewd", op:"add", value:2}
	...
	"HE-IN-005":{
		name:{ "KOR":"Essence of Serenity" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
	...
	"HE-IN-005-1":{
		parents:"HE-IN-005",
		name:{ "KOR":"Serenity" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"HE-IN-005-2":{
		parents:"HE-IN-005",
		name:{ "KOR":"Deep Serenity" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"HE-IN-006":{
		name:{ "KOR":"Essence of Echo" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
	...
	"HE-IN-007":{
		name:{ "KOR":"Essence of Immobility" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
	...
	"HE-IN-008":{
		name:{ "KOR":"Essence of Swiftness" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
			{trigger:"selected", cond:true, type:"maxUse", target:"self", value:1}
	...
	"HE-IN-009":{
		name:{ "KOR":"Essence of Vampirism" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:5, owner:1,
		cond:false,
		tags:["Essence", "기본Essence"],
		effect:[
	...
	"HE-IN-009-1":{
		name:{ "KOR":"Life Drain" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"HE-NM-CO-001":{
		name:{ "KOR":"Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"HE-NM-AT-001":{
		name:{ "KOR":"Holy Flame" }, class:"Healer", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true, meet:{v1:"자신.기록.최근.이벤트.Excitement.감소", op:">", v2:0},
		tags:["Deck빌딩", "race:Eldorian", "group:회복", "act:caress"],
	...
	"HE-NM-AT-002":{
		name:{ "KOR":"Soul Whip" }, class:"Healer", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:회복", "act:fellatio"],
	...
	"HE-NM-AT-003":{
		name:{ "KOR":"Life Bond" }, class:"Healer", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:회복", "act:penetration"],
		...
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"self", op:"add", value:-2},
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", value:"자신.RemainingExcitement"}
		]
	},
	"HE-NM-AT-004":{
		name:{ "KOR":"Radiant Aura" }, class:"Healer", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "결합", "race:Eldorian", "group:결합", "group:Essence", "act:caress"],
	...
	"HE-NM-AT-004-1":{
		...
		name:{ "KOR":"Radiant Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"HE-NM-AT-005":{
		name:{ "KOR":"Light of Purification" }, class:"Healer", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Corruption"],
	...
	"HE-NM-AT-006":{
		name:{ "KOR":"Natural Extraction" }, class:"Healer", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Essence", "act:fellatio"],
		flavorText:{ "KOR":"Natural healing is a technique that directly deals with the concept of life force possessed by living beings.<br>As it mainly developed from the folk remedies of Beastfolk shamans, it is not systematic, but its effectiveness is recognized and studied by the Albion Medical Association." },
		...
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"randomCard(tags, Essence)", repeat:2},
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},
	"HE-NM-AT-007":{
		name:{ "KOR":"Release Restraint" }, class:"Healer", type:"attack", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "결합", "race:Eldorian", "group:결합"],
		...
		effect:[
			{trigger:"choice", cond:true, range:{category:"type", value:"Penalty", count:"M3"}, type:"combine", target:"self", value:"HE-NM-AT-007-1"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},
	"HE-NM-AT-007-1":{
		parents:"HE-NM-AT-007",
		name:{ "KOR":"Waste Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"HE-NM-SU-001":{
		name:{ "KOR":"Wave of Healing" }, class:"Healer", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:회복"],
	...
	"HE-NM-SU-001-1":{
		...
		name:{ "KOR":"Ripple of Healing" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"active", duration:1,
		effect:[
	...
	"HE-NM-SU-002":{
		name:{ "KOR":"Grant Vitality" }, class:"Healer", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:회복", "group:Corruption"],
	...
	"HE-NM-SU-003":{
		name:{ "KOR":"Quick Prescription" }, class:"Healer", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "결합", "race:Eldorian", "group:결합", "group:Essence"],
		...
		effect:[
			{trigger:"choice", cond:true, range:{category:"tags", value:"Essence", count:2}, type:"combine", target:"self", value:"HE-NM-SU-003-1"},
			{trigger:"selected", cond:true, type:"maxUse", target:"self", value:1},
		]
	},
	"HE-NM-SU-003-1":{
	...
	"HE-NM-SU-004":{
		name:{ "KOR":"Infinite Aura" }, class:"Healer", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "결합", "race:Silvani", "group:결합", "group:Essence"],
	...
	"HE-NM-SU-004-1":{
		...
		name:{ "KOR":"Infinite Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"HE-NM-SU-005":{
		name:{ "KOR":"Potion Alchemy" }, class:"Healer", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Corruption", "group:결합", "group:Essence"],
		...
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"randomCard(tags, Essence)", repeat:3},
			{trigger:"used", cond:true, type:"corrupt", 
			info:{
				value:5,
				effect:[
	...
	"HE-NM-SU-005-1":{
		...
		name:{ "KOR":"Potion Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"HE-NM-SU-006":{
		name:{ "KOR":"Celestial Blessing" }, class:"Healer", type:"Support", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:회복"],
	...
	"HE-NM-SU-006-1":{
		...
		name:{ "KOR":"Restoration" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"active", duration:1,
		effect:[
	...
	"HE-NM-SU-006-2":{
		parents:"HE-NM-SU-006",
		name:{ "KOR":"Blessing Shield" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"HE-NM-PS-001":{
		name:{ "KOR":"Trauma Care" }, class:"Healer", type:"Position", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:회복", "group:Corruption", "Unimproved"], related:["HE-NM-PS-001-3","HE-NM-PS-001-2","HE-NM-PS-001-4"],
	...
	"HE-NM-PS-001-3":{
		name:{ "KOR":"Instant Heal" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"self", op:"add", value:-2},
	...
	"HE-NM-PS-002":{
		name:{ "KOR":"Fracture Treatment" }, class:"Healer", type:"Position", isDeck:true, rarity:"Normal", cost:10, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:회복", "group:Corruption", "group:결합", "Unimproved"], related:["HE-NM-PS-002-2"],
	...
	"HE-NM-PS-002-2":{
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"개선치료"},
			{trigger:"used", cond:true, type:"posture"},
			{trigger:"always", cond:true, type:"lewd", op:"add", value:2, repeat:"자신.기록.전체.사용.count(tags, Combination)"}
		]
	},


	"HE-EX-AT-001":{
		name:{ "KOR":"Holy Explosion" }, class:"Healer", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Corruption", "act:penetration"],
	...
	"HE-EX-AT-002":{
		name:{ "KOR":"Heart Pounding" }, class:"Healer", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "act:penetration"],
	...
	"HE-EX-AT-003":{
		name:{ "KOR":"Artificial Extraction" }, class:"Healer", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:Essence", "act:fellatio"],
		...
		effect:[
			{trigger:"used", cond:true, type:"get", target:"self", value:"자기Deck.selectCards(tags, Essence, 2)"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},
	"HE-EX-AT-004":{
		name:{ "KOR":"Whisper of the Soul" }, class:"Healer", type:"attack", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:결합"],
	...
	"HE-EX-SU-001":{
		name:{ "KOR":"Prayer of Revival" }, class:"Healer", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:회복"],
	...
	"HE-EX-SU-002":{
		name:{ "KOR":"Illusory Aura" }, class:"Healer", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "결합", "race:Halfling", "group:Corruption", "group:결합", "group:Essence"],
	...
	"HE-EX-SU-002-1":{
		...
		name:{ "KOR":"Illusory Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"HE-EX-SU-003":{
		name:{ "KOR":"Synthesis" }, class:"Healer", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "결합", "race:Silvani", "group:회복", "group:결합", "group:Essence"],
		...
		effect:[
			...
			{trigger:"choice", cond:true, range:{category:"tags", value:"Essence", count:3}, type:"combine", target:"self", value:"HE-EX-SU-003-1"}
		]
	},
	"HE-EX-SU-003-1":{
	...
	"HE-EX-SU-004":{
		name:{ "KOR":"First Aid" }, class:"Healer", type:"Support", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true, meet:{v1:"자신.기록.최근.이벤트.Excitement.감소", op:">", v2:0},
		tags:["Deck빌딩", "race:Silvani", "group:회복"],
	...
	"HE-EX-SU-004-1":{
		...
		name:{ "KOR":"Emergency Healing" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"active", duration:1,
		effect:[
	...
	"HE-EX-SU-004-2":{
		parents:"HE-EX-SU-004",
		name:{ "KOR":"Successful Treatment" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"HE-EX-PS-001":{
		name:{ "KOR":"Poison Treatment" }, class:"Healer", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Eldorian", "group:Corruption", "group:결합", "group:Essence", "Unimproved"], related:["HE-EX-PS-001-2"],
	...
	"HE-EX-PS-001-2":{
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"개선치료"},
			{trigger:"used", cond:true, type:"posture"},
			{trigger:"turnStart", cond:{v1:"자기Deck.count(tags, Essence)", op:">=", v2:2}, condOmit:true, type:"combine", target:"self",  info:{target:"자기Deck.selectCards(tags, Essence, 2)"}, value:"HE-NM-SU-003-1"},
		]
	},

	"HE-EX-PS-002":{
		name:{ "KOR":"Infection Treatment" }, class:"Healer", type:"Position", isDeck:true, rarity:"expert", cost:15, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Corruption", "Unimproved"], related:["HE-EX-PS-002-2"],
	...
	"HE-UL-AT-001":{
		name:{ "KOR":"Life Force Rampage" }, class:"Healer", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:회복", "act:fellatio"],
	...
	"HE-UL-AT-002":{
		name:{ "KOR":"Mass Purification" }, class:"Healer", type:"attack", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Beastfolk", "group:Corruption", "act:caress"],
		...
		effect:[
			...
			info:{
				value:10,
				effect:[
					{trigger:"used", cond:true, adverb:"Also", type:"orgasm", target:"op"}
				]
			}},
		]
	},
	...
	"HE-UL-SU-001":{
		name:{ "KOR":"Aura of All Things" }, class:"Healer", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "결합", "race:Halfling", "group:결합"],
	...
	"HE-UL-SU-001-1":{
		...
		name:{ "KOR":"All at Once" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"HE-UL-SU-002":{
		name:{ "KOR":"Elixir of Immortality" }, class:"Healer", type:"Support", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Halfling", "group:Essence"], related:["HE-IN-999"], keywords:["Corruptionn"],
	...
	"HE-IN-999":{
		name:{ "KOR":"Essence of Eternity" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:false,
		tags:["Essence"],
		effect:[
			...
			{trigger:"used", cond:true, adverb:"and", type:"get", target:"self", value:"self"}
		]
	},

	"HE-UL-PS-001":{
		name:{ "KOR":"Psychotherapy" }, class:"Healer", type:"Position", isDeck:true, rarity:"Ultimate", cost:20, owner:1,
		cond:true,
		tags:["Deck빌딩", "race:Silvani", "group:회복", "group:Corruption", "Unimproved"], related:["HE-UL-PS-001-2"],
...
//#######################################################################################################################################################################################
	...
	"BN-EL-001":{
		name:{ "KOR":"Wild Card" }, class:"Neutral", type:"wildcard", isDeck:true, rarity:"None", race:"Eldorian", cost:10, owner:1, nochange:true,
		cond:true,
		tags:["보너스", "불가침"],
		effect:[
	...
	"BN-SY-001":{
		name:{ "KOR":"Engineering: Merylon" }, class:"Neutral", type:"Arcane", isDeck:true, rarity:"None", race:"Silvani", cost:15, owner:1,
		cond:true,
		tags:["보너스", "불가침", "Arcane"],
		effect:[
	...
	"BN-SY-004-1":{
		parents:"BN-SY-004",
		name:{ "KOR":"Foresight" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", race:"Silvani", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["불가침"],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"BN-SY-005-1":{
		parents:"BN-SY-005",
		name:{ "KOR":"Death Denied" }, class:"Neutral", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		expiration:"turnEnd", duration:1,
		tags:[],
		effect:[
	...
	"BN-HA-001":{
		name:{ "KOR":"Custom Card" }, class:"Neutral", type:"Crafted", isDeck:true, rarity:"None", race:"Halfling", cost:0, owner:1,
		cond:true,
		tags:["보너스", "불가침"],
		stack:1,
		effect:[
	...
	"BN-HA-001-2":{
		parents:"BN-HA-001",
		name:{ "KOR":"Custom Combination" }, class:"Healer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Combination"],
		effect:[
		]
	...
	"BN-TR-001":{
		name:{ "KOR":"Unyielding Spirit" }, class:"Warrior", type:"시련", isDeck:true, rarity:"None", race:"Beastfolk", cost:20, owner:1,
		cond:{v1:"자신.기록.전체.버림.count(type, Penalty)", op:">=", v2:6},
		tags:["보너스", "불가침", "시련"],
		effect:[
			{trigger:"used", cond:true, type:"victory", target:"self"},
			{trigger:"none", cond:true, type:"showValue", value:"자신.기록.전체.버림.count(type, Penalty)"},
		]
	},		
	"BN-TR-002":{
		name:{ "KOR":"The Final Mission" }, class:"Assassin", type:"시련", isDeck:true, rarity:"None", race:"Beastfolk", cost:20, owner:1,
	...
	"BN-TR-003":{
		name:{ "KOR":"Prophecy of the End" }, class:"Mage", type:"시련", isDeck:true, rarity:"None", race:"Beastfolk", cost:20, owner:1,
		cond:true,
	...
	"BN-TR-003-1":{
		name:{ "KOR":"Verse I: The Omen" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", race:"Beastfolk", cost:0, owner:1, nochange:true,
		cond:true,
	...
	"BN-TR-003-2":{
		name:{ "KOR":"Verse II: The Calamity" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", race:"Beastfolk", cost:0, owner:1, nochange:true,
		cond:true,
	...
	"BN-TR-003-3":{
		name:{ "KOR":"Verse III: Doomsday" }, class:"Mage", type:"Support", isDeck:true, rarity:"None", race:"Beastfolk", cost:0, owner:1, nochange:true,
		cond:true,
	...
	"BN-TR-003-4":{
		parents:"BN-TR-003",
		name:{ "KOR":"Finale: Fate Defied" }, class:"Mage", type:"attack", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true, noInherit:true,
		cond:true,
		tags:["시련", "불가침"],
		effect:[
			{trigger:"used", cond:true, type:"victory", target:"self"},
	...
	"BN-TR-004-1":{
		parents:"BN-TR-004",
		name:{ "KOR":"Golden Hour" }, class:"Healer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["시련", "불가침"],
		expiration:"always", duration:Infinity,
		effect:[
...
//#######################################################################################################################################################################################
	...
	"PN-001":{
		name:{ "KOR":"Penalty: Masturbation" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-15, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-002":{
		name:{ "KOR":"Penalty: Ahegao" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-003":{
		name:{ "KOR":"Penalty: In Heat" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-004":{
		name:{ "KOR":"Penalty: Urination" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
			{trigger:"turnEnd", inDeck:true, cond:true, type:"line", value:"urination"},
			{trigger:"turnEnd", inDeck:true, cond:{v1:"Opponent.Excitement", op:">", v2:0}, condOmit:true, type:"excite", target:"op", op:"add", value:-2},
		]
	},
	"PN-005":{
		name:{ "KOR":"Penalty: Moaning" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-10, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-006":{
		name:{ "KOR":"Penalty: Squirting" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-15, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-007":{
		name:{ "KOR":"Penalty: Sensitivity" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-15, owner:1, nochange:true,    
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-008":{
		name:{ "KOR":"Penalty: Masochism" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-10, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-009":{
		name:{ "KOR":"Penalty: Frustration" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:-5, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
	...
	"PN-010":{
		name:{ "KOR":"Penalty: Surrender" }, class:"Penalty", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Deck빌딩"],
		effect:[
			{trigger:"used", cond:true, type:"defeat", target:"self"},
...
//#######################################################################################################################################################################################
	...
	"B1-PA-001":{
		...
		cond:true,
		tags:["Champion능력", "노말전용"], related:["B1-PN-001"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"B1-PN-001":{
		name:{ "KOR":"Goblin Cum" }, class:"Goblins", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["Champion토큰", "노말전용"],
		effect:[
	...
	"B1-UC-001":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"clothes", value:"uncloth"},
			{trigger:"used", cond:true, type:"get", target:"op", value:"randomCard(type, Penalty)"},
		]
	},
	"B1-AT-001":{
		name:{ "KOR":"Breast Squeezing" }, class:"Goblins", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B1-PN-001"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"가슴쥐어짜기"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:{v1:"Deck.count(id, B1-PN-001)", op:">", v2:0}, adverb:"Also", type:"attack", target:"op"},
		]
	},
	"B1-AT-002":{
		name:{ "KOR":"Double Penetration" }, class:"Goblins", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "노말전용"],
		effect:[
			{trigger:"used", cond:{v1:"Deck.count(type, Penalty)", op:">", v2:0}, type:"line", value:"고블린penetration"},
			{trigger:"used", cond:true, type:"attack", repeat:"Deck.count(type, Penalty)", target:"op"},
		]
	},
	"B1-AT-003":{
		name:{ "KOR":"Deepthroat" }, class:"Goblins", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
	...
	"B1-AT-003-1":{
		parents:"B1-AT-003",
		name:{ "KOR":"Breathlessness" }, class:"Goblins", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"B1-AT-004":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"Heat", op:"add", value:"Deck.count(type, Penalty)"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},
	"B1-SU-001":{
		name:{ "KOR":"Hair Pulling" }, class:"Goblins", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B1-PN-001"],
		effect:[
			{trigger:"used", cond:true, type:"Heat", op:"add", value:2},
	...
	"B1-SU-002":{
		name:{ "KOR":"Mounting" }, class:"Goblins", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"used", cond:{v1:"Deck.count(type, Penalty)", op:">=", v2:3}, type:"line", value:"탑승"},
			{trigger:"used", cond:{v1:"Deck.count(type, Penalty)", op:">=", v2:3}, type:"orgasm", target:"op"},
		]
	},
	...
	"B1-UC-001+":{
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"옷찢기"},
			{trigger:"used", cond:true, type:"clothes", value:"uncloth"},
			{trigger:"used", cond:true, type:"get", target:"op", repeat:2, value:"randomCard(type, Penalty)"},
		]
	},
	"B1-AT-002+":{
		parents:"B1-AT-002",
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"고블린penetration"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:true, type:"attack", adverb:"Also", repeat:"OpponentDeck.count(type, Penalty)", target:"op"},
		]
	},

	"B1-AT-005":{
		name:{ "KOR":"Gangbang" }, class:"Goblins", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "클라이맥스"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"고블린penetration"},
	...
	"B2-PA-001":{
		name:{ "KOR":"Brainwashing" }, class:"Villager", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion능력", "노말전용"], related:["B2-PA-001-1", "B2-PA-001-2"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"B2-PA-001-1":{
		...
		cond:true,
		tags:["Champion토큰", "노말전용"], related:["B2-PA-001-2"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"B2-PA-001-2":{
		...
		cond:true,
		tags:["Champion토큰", "노말전용"], related:["B2-PA-001-1"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"B2-PN-001":{
		name:{ "KOR":"Yes, Master" }, class:"Villager", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion토큰", "무조건소모", "노말전용"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"네주인님"},
			{trigger:"used", cond:true, type:"Heat", op:"add", value:1},
			{trigger:"used", cond:true, type:"get", adverb:"and", target:"self", value:"original"},
			{trigger:"selected", cond:true, type:"maxUse", target:"self", value:1},
		]
	},
	...
	"B2-UC-001":{
		...
		effect:[
			...
			info:{
				target:"opDeck.selectCards(all, Penalty제외, 2)",
				value:"B2-PN-001",
			}},
		]
	},
	"B2-AT-001":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"transform", target:"op",
			info:{
				target:"opDeck.selectCards(type, attack, 1)",
				value:"B2-PN-001",
			}},
		]
	},
	"B2-AT-002":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"transform", target:"op",
			info:{
				target:"opDeck.selectCards(type, Support, 1)",
				value:"B2-PN-001",
			}},
		]
	},
	"B2-AT-004":{
		name:{ "KOR":"Orgasm" }, class:"Villager", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
	...
	"B2-SU-001":{
		name:{ "KOR":"Crawl on All Fours" }, class:"Villager", type:"Position", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"B2-SU-002":{
		name:{ "KOR":"Stay Still" }, class:"Villager", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
	...
	"B2-SU-002-1":{
		parents:"B2-SU-002",
		name:{ "KOR":"Immobilized" }, class:"Villager", type:"상태", isDeck:false, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"B2-SU-004":{
		name:{ "KOR":"Cognitive Impairment" }, class:"Villager", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"인지저해"},
			{trigger:"used", cond:true, type:"discard", target:"op", info:{target:"opDeck.selectCards(type, Penalty, all)"}},
			{trigger:"used", cond:true, type:"Heat", op:"add", value:"Opponent.기록.이번.버림.count(type, Penalty)"},
		]
	},
	...
	"B2-PA-001+":{
		...
		effect:[
			{trigger:"gameStart", cond:true, type:"line", value:"최면석판"},
			{trigger:"gameStart", cond:true, type:"state", target:"op", byname:true, value:"B2-PA-001-1+"},
			{trigger:"turnEnd", cond:{v1:"Opponent.기록.이번.사용.length", op:"==", v2:0}, type:"Heat", op:"add", value:2},
		]
	},
	"B2-PA-001-1+":{
		parents:"B2-PA-001-1",
	...
	"B2-UC-001+":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"transform", target:"op",
			info:{
				target:"opDeck.selectCards(all, Penalty제외, 3)",
				value:"B2-PN-001",
			}},
		]
	},
	"B2-AT-001+":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"transform", target:"op",
			info:{
				target:"opDeck.selectCards(type, attack, 2)",
				value:"B2-PN-001",
			}},
		]
	},
	"B2-AT-002+":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"transform", target:"op",
			info:{
				target:"opDeck.selectCards(type, Support, 2)",
				value:"B2-PN-001",
			}},
		]
	},
	...
	"B2-AT-003":{
		name:{ "KOR":"Increase Sensitivity" }, class:"Villager", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "클라이맥스"],
		effect:[
	...
	"B3-PA-001":{
		...
		cond:true,
		tags:["Champion능력", "노말전용"], related:["B3-PA-001-1"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"B3-PA-001-1":{
		name:{ "KOR":"Tentacle Insertion" }, class:"Tentacle Slime", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion토큰", "노말전용"],
		effect:[
			{trigger:"used", cond:true, type:"Heat", op:"add", value:1},
	...
	"B3-AT-001":{
		name:{ "KOR":"Internal Churning" }, class:"Tentacle Slime", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"촉수attack"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:{v1:"Lewdness", op:"<=", v2:2}, adverb:"Also", type:"attack", target:"op"},
		]
	},
	"B3-AT-003":{
		name:{ "KOR":"Throat Invasion" }, class:"Tentacle Slime", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"촉수attack"},
	...
	"B3-AT-004":{
		name:{ "KOR":"Wriggling Tentacles" }, class:"Tentacle Slime", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B3-PA-001-1"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"촉수attack"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
	...
	"B3-SU-001":{
		name:{ "KOR":"Restraining Tentacles" }, class:"Tentacle Slime", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
	...
	"B3-SU-002":{
		name:{ "KOR":"Saliva Ingestion" }, class:"Tentacle Slime", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "노말전용"],
		effect:[
	...
	"B3-SU-003-1":{
		parents:"B3-SU-003",
		name:{ "KOR":"Protective Slime" }, class:"Tentacle Slime", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:2,
		effect:[
	...
	"B3-AT-001+":{
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"촉수attack"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:{v1:"Lewdness", op:"<=", v2:4}, adverb:"Also", type:"attack", target:"op"},
		]
	},
	"B3-SU-002+":{
		parents:"B3-SU-002",
	...
	"B3-AT-002":{
		name:{ "KOR":"Slime Ejaculation" }, class:"Tentacle Slime", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "클라이맥스"], related:["B3-PA-001-1"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"촉수attack"},
			{trigger:"used", cond:true, type:"state", target:"self", value:"B3-SU-003-1"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
	...
	"B4-UC-001":{
		...
		effect:[
			...
			{trigger:"used", cond:true, type:"clothes", value:"uncloth"},
			{trigger:"used", cond:{v1:"Opponent.기록.이번.사용.length", op:">", v2:0}, type:"stack", info:{target:"id:B4-PA-001"}, op:"add", value:1},
		]
	},
	"B4-AT-001":{
		name:{ "KOR":"Cheeky Grope" }, class:"Imp", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
	...
	"B4-AT-002":{
		name:{ "KOR":"Clingy Hug" }, class:"Imp", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
	...
	"B4-SU-001":{
		name:{ "KOR":"Now You're It" }, class:"Imp", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
	...
	"B4-SU-002":{
		name:{ "KOR":"Penalty Game" }, class:"Imp", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:{v1:"Opponent.기록.이전.이벤트.Orgasm", op:">", v2:0},
		tags:["ChampionDeck"], related:["B4-PA-001"],
		effect:[
	...
	"B4-SU-003":{
		name:{ "KOR":"Teasing" }, class:"Imp", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:{v1:"Opponent.기록.이전.사용.length", op:">=", v2:2},
		tags:["ChampionDeck", "노말전용"], related:["B4-PA-001"],
		effect:[
	...
	"B4-SU-001+":{
		...
		effect:[
			{trigger:"used", cond:true, type:"line", value:"이제누나가술래야"},
			{trigger:"used", cond:true, type:"stack", info:{target:"id:B4-PA-001+"}, op:"add", value:1, keepLine:true},
			{trigger:"used", cond:true, type:"get", target:"self", value:"self", adverb:"and", keepLine:true},
			{trigger:"selected", cond:true, type:"maxUse", target:"self", value:1}
		]
	},
	"B4-SU-002+":{
	...
	"B4-SU-003+":{
		...
		name:{ "KOR":"Teasing+" }, class:"Imp", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:{v1:"Opponent.기록.이전.사용.length", op:">=", v2:2},
		tags:["ChampionDeck", "Hard Only"], related:["B4-PA-001+"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"약올리기"},
			{trigger:"used", cond:true, type:"stack", info:{target:"id:B4-PA-001+"}, op:"add", value:1, keepLine:true},
			{trigger:"used", cond:true, type:"get", target:"self", value:"self", adverb:"and", keepLine:true},
	...
	"B5-PA-001":{
		name:{ "KOR":"Massive Erection" }, class:"Tauros", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion능력", "노말전용"],
		expiration:"always", duration:Infinity, stack:1,
		effect:[
	...
	"B5-AT-001":{
		name:{ "KOR":"Sexual Release" }, class:"Tauros", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Tauros울음"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:true, type:"attack", target:"self"},
		]
	},
	"B5-AT-002":{
		name:{ "KOR":"Lift and Fuck" }, class:"Tauros", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Tauros울음"},
	...
	"B5-SU-001":{
		name:{ "KOR":"Courtship" }, class:"Tauros", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
	...
	/*"B5-PN-001":{
		name:{ "KOR":"Rest" }, class:"Tauros", type:"Penalty", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"always", inDeck:true, cond:{v1:"자신.기록.이전.이벤트.Orgasm", op:">", v2:0}, type:"penaltyMustUse", target:"self"},
	...
	"B5-AT-003":{
		name:{ "KOR":"Breeding Press" }, class:"Tauros", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "클라이맥스"],
		effect:[
	...
	"B6-PA-001":{
		...
		effect:[
			...
			//{trigger:"turnEnd", cond:true, type:"bound", info:{target:"OpponentDeck.selectCards(all, Spore제외, 1)"}, target:"op", value:"randomCard(tags, Spore)"},
		]
	},
	"B6-PA-001-1":{
	...
	"B6-ST-001":{
		...
		tags:["ChampionDeck"],
		effect:[
			{trigger:"turnStart", cond:true, type:"bound", info:{target:"자기Deck.selectCards(all, Spore제외, 1)"}, target:"self", value:"randomCard(tags, Spore)"},
		]
	},
	...
	"B6-AT-002":{
		name:{ "KOR":"Nutrient Absorption" }, class:"Mushroom Man", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["tag:Spore"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"양분흡수"},
			{trigger:"used", cond:true, type:"attack", target:"op", repeat:"OpponentDeck.count(tags, Spore)"},
			{trigger:"used", cond:true, type:"get", target:"self", value:"B6-AT-002"},
		]
	},
	/*"B6-SU-001":{
		name:{ "KOR":"Parasitic Control" }, class:"Mushroom Man", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["tag:Spore"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"기생조종"},
			{trigger:"used", cond:{v1:"OpponentDeck.count(tags, Spore)", op:">=", v2:3}, type:"orgasm", target:"op"},
		]
	},
	"B6-SU-001-1":{
		parents:"B6-SU-001",
	...
	"B6-SU-002":{
		name:{ "KOR":"Territory Expansion" }, class:"Mushroom Man", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B6-ST-001", "tag:Spore"],
		effect:[
			{trigger:"used", cond:true, type:"state", target:"op", value:"B6-ST-001", byname:true},
	...
	"B6-SU-003":{
		name:{ "KOR":"Mental Connection" }, class:"Mushroom Man", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B6-SU-003-2"],
		effect:[
	...
	"B6-AT-003":{
		name:{ "KOR":"Sowing Seeds" }, class:"Mushroom Man", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "클라이맥스"],
		effect:[
	...
	"B6-AT-003+":{
		...
		name:{ "KOR":"Sowing Seeds+" }, class:"Mushroom Man", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "클라이맥스"], related:["B6-AT-001+"],
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"op", op:"add", value:2},
			{trigger:"used", cond:true, type:"get", target:"self", value:"B6-AT-001+", repeat:3},
		]
	...
	"B7-PA-001-1":{
		parents:"B7-PA-001",
		name:{ "KOR":"Unknown Action" }, class:"Blonde Thug", type:"-", rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		effect:[
	...
	"B7-AT-001":{
		name:{ "KOR":"Deep Thrusting" }, class:"Blonde Thug", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde Thug attack"], related:["tag:Blonde Thug attack"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"깊게박아넣기"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:{v1:"Opponent.기록.이번.이벤트.자극함", op:">", v2:0}, adverb:"Also", type:"attack", target:"op"},
		]
	},
	"B7-AT-002":{
		name:{ "KOR":"Gentle Intercourse" }, class:"Blonde Thug", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde Thug attack"], related:["tag:Blonde Thug attack"],
		effect:[
	...
	"B7-AT-003":{
		name:{ "KOR":"Forcibly Rough" }, class:"Blonde Thug", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde Thug attack"], related:["tag:Blonde Thug attack"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"강제로거칠게"},
			{trigger:"used", cond:true, type:"attack", target:"op", repeat:"Opponent.기록.이번.사용.length"},
		]
	},
	"B7-AT-004":{
		name:{ "KOR":"Filling Up" }, class:"Blonde Thug", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde Thug attack"], related:["tag:Blonde Thug attack"],
		effect:[
	...
	/*"B7-SU-001":{
		name:{ "KOR":"Melting Kiss" }, class:"Blonde Thug", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde ThugSupport"], related:["tag:Blonde ThugSupport"],
		effect:[
	...
	"B7-SU-002":{
		name:{ "KOR":"Casual Skinship" }, class:"Blonde Thug", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde ThugSupport"], related:["tag:Blonde ThugSupport"],
		effect:[
	...
	"B7-SU-003":{
		name:{ "KOR":"Spreading Legs" }, class:"Blonde Thug", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde ThugSupport"], related:["tag:Blonde ThugSupport"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"다리벌리기"},
			{trigger:"used", cond:true, type:"Heat", op:"add", value:2},
			{trigger:"used", cond:{v1:"Opponent.기록.이번.이벤트.자극함", op:"==", v2:0}, adverb:"Also", type:"Heat", op:"add", value:2},
		]
	},
	/*"B7-SU-004":{
		name:{ "KOR":"Licking and Sucking" }, class:"Blonde Thug", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde ThugSupport"], related:["tag:Blonde ThugSupport"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"핥고빨기"},
			{trigger:"used", cond:{v1:"Heat", op:">", v2:1}, condOmit:true, type:"Heat", op:"add", value:2},
			{trigger:"used", cond:{v1:"Heat", op:"<=", v2:1}, adverb:"Instead", type:"Heat", op:"add", value:5},
		]
	},*/
	...
	"B7-AT-005":{
		name:{ "KOR":"Engraving Pleasure" }, class:"Blonde Thug", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Blonde Thug클라이맥스", "클라이맥스"], related:["tag:Blonde Thug클라이맥스"],
		effect:[
	...
	"B8-PA-001":{
		...
		cond:true,
		tags:["Champion능력", "노말전용"], related:["tag:Rule", "B8-PA-001-1"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"turnStart", cond:true, type:"state", target:"op", value:"randomCard(tags, Rule)"},
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"If you submit to the rules, you receive a <b>[Mark of Submission]</b>." }}
		]
	},
	"B8-PA-001-1":{
		name:{ "KOR":"Mark of Submission" }, class:"Trainer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"B8-PA-001-2":{
		name:{ "KOR":"Do Not Resist" }, class:"Trainer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Rule"], related:["B8-PA-001-1"],
		expiration:"turnEnd", duration:1,
		effect:[
			{trigger:"turnEnd", cond:{v1:"자신.기록.이번.사용.count(type, attack)", op:"==", v2:0}, type:"state", target:"self", value:"B8-PA-001-1", byname:true},
			{trigger:"turnEnd", cond:{v1:"자신.기록.이번.사용.count(type, attack)", op:"!=", v2:0}, type:"shake"},
		]
	},
	"B8-PA-001-3":{
		name:{ "KOR":"Do Not Judge" }, class:"Trainer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Rule"], related:["B8-PA-001-1"],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"B8-PA-001-4":{
		...
		expiration:"turnEnd", duration:1,
		effect:[
			{trigger:"turnEnd", cond:{v1:"자기Deck.count(type, Penalty)", op:">", v2:0}, type:"state", target:"self", value:"B8-PA-001-1", byname:true},
			{trigger:"turnEnd", cond:{v1:"자기Deck.count(type, Penalty)", op:"==", v2:0}, type:"shake"},
		]
	},
	"B8-PA-001-5":{
	...
	"B8-PA-001-6":{
		name:{ "KOR":"Know Your Place" }, class:"Trainer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Rule"], related:["B8-PA-001-1"],
		expiration:"turnEnd", duration:1,
		effect:[
	...
	"B8-UC-001-1":{
		name:{ "KOR":"Desperate Resistance" }, class:"Trainer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:1, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B8-PA-001-1"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"필사적인Resistant"},
			{trigger:"used", cond:true, type:"remove", target:"self", info:{target:"자신.상태.selectCards(id, B8-PA-001-1, 2)"}},
		]
	},

	"B8-AT-001":{
		name:{ "KOR":"Pleasure Training" }, class:"Trainer", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"쾌락조교"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:{v1:"Opponent.Excitement", op:"==", v2:0}, adverb:"Also", type:"attack", target:"op"},
		]
	},
	"B8-AT-002":{
		name:{ "KOR":"Drug Training" }, class:"Trainer", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["tag:Potion"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Potion조교"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
			{trigger:"used", cond:true, type:"state", target:"op", value:"randomCard(tags, Potion)"},
		]
	},
	"B8-AT-003":{
	...
	"B8-AT-003-1":{
		parents:"B8-AT-003",
		name:{ "KOR":"Torture Aftermath" }, class:"Trainer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[], related:["Penalty"],
		expiration:"active", duration:1,
		effect:[
			{trigger:"turnStart", cond:true, type:"get", target:"self", value:"randomCard(type, Penalty)"},
		]
	},
	"B8-SU-001":{
		name:{ "KOR":"Hope Torture" }, class:"Trainer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B8-PA-001-1"],
		effect:[
			{trigger:"used", cond:true, type:"excite", target:"self", op:"add", value:-5},
	...
	"B8-SU-002-1":{
		parents:"B8-SU-002",
		name:{ "KOR":"Development Complete" }, class:"Trainer", type:"상태", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:[],
		expiration:"turnEnd", duration:3,
		effect:[
	...
	"B8-SU-003":{
		name:{ "KOR":"Whipping" }, class:"Trainer", type:"Support", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck"], related:["B8-PA-001-1"],
		effect:[
	...
	"B8-PA-001+":{
		...
		name:{ "KOR":"Submission Training+" }, class:"Trainer", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion능력", "Hard Only"], related:["tag:Rule", "B8-PA-001-1"],
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"turnStart", cond:true, type:"state", target:"op", value:"randomCard(tags, Rule)", repeat:2},
			{trigger:"none", cond:true, type:"caption", value:{ "KOR":"If you submit to the rules, you receive a <b>[Mark of Submission]</b>." }}
		]
	},
	"B8-UC-001+":{
	...
	"B8-AT-002+":{
		...
		name:{ "KOR":"Drug Training+" }, class:"Trainer", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "Hard Only"], related:["tag:Potion", "B8-PA-001-1"],
		effect:[
			{trigger:"used", cond:true, type:"line", value:"Potion조교"},
			{trigger:"used", cond:true, type:"state", target:"op", value:"randomCard(tags, Potion)", repeat:"Opponent.상태.count(id, B8-PA-001-1)"},
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},
	"B8-AT-003+":{
	...
	"B8-AT-004":{
		name:{ "KOR":"Punishment" }, class:"Trainer", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "클라이맥스"], related:["B8-PA-001-1"],
		effect:[
	...
	"BC-AT-001":{
		name:{ "KOR":"Struggling" }, class:"Neutral", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "챌린지전용", "클라이맥스"],
		effect:[
			{trigger:"used", cond:true, type:"attack", target:"op"},
		]
	},
	...
	"BC1-PA-001":{
		name:{ "KOR":"Goblin Den" }, class:"Goblins", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
	...
	"BC2-PA-001":{
		name:{ "KOR":"Waste of Time" }, class:"Villager", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion능력", "챌린지전용"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"BC3-PA-001":{
		name:{ "KOR":"Hyper Regeneration" }, class:"Tentacle Slime", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion능력", "챌린지전용"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"BC5-PA-001":{
		name:{ "KOR":"Self-Destruction" }, class:"Tauros", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion능력", "챌린지전용"],
		expiration:"always", duration:Infinity,
		effect:[
	...
	"BC5-AT-001":{
		parents:"B5-AT-003",
		name:{ "KOR":"Rampage Sex" }, class:"Tauros", type:"attack", isDeck:true, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["ChampionDeck", "챌린지전용", "클라이맥스"],
		effect:[
			{trigger:"used", cond:true, type:"Heat", op:"add", value:2},
	...
	"BC6-PA-001":{
		...
		expiration:"always", duration:Infinity,
		effect:[
			{trigger:"turnStart", cond:true, type:"bound", info:{target:"OpponentDeck.selectCards(all, Spore제외, 1)"}, target:"op", value:"BC6-PA-001-1"},
		]
	},
	"BC6-PA-001-1":{
	...
	"BC8-PA-001":{
		name:{ "KOR":"Orgasm Prohibition" }, class:"Trainer", type:"특성", isDeck:false, rarity:"None", cost:0, owner:0, nochange:true,
		cond:true,
		tags:["Champion능력", "챌린지전용"],
		expiration:"always", duration:Infinity,
		effect:[
...
Object.keys(cardDB).forEach(id => {
	...
	if((cardDB[id].type == "특성" && id != "DA-NT-ALL-000") || cardDB[id].tags.includes("Deck빌딩") || cardDB[id].tags.includes("기본Crafted") || (cardDB[id].tags.includes("기본Magic") && cardDB[id].tags.includes("즉발 Magic")) || cardDB[id].tags.includes("기본Essence") || cardDB[id].tags.includes("보너스")) {
...
function generateCardExcel() {
    ...
    const filteredCards = Object.entries(cardDB).filter(([id, card]) => (
        (card.tags && card.tags.includes("Deck빌딩")) || 
