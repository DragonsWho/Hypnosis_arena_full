const cardTexts = {
	...
	"target":{
		...
		"Passive시간": { "KOR": "{target}'s duration" },
	...
	"effect":{
		...
		"증가숫자": { "KOR": "Increase <b>{value}</b> by {amount}{repeat}." },
		"감소숫자": { "KOR": "Decrease <b>{value}</b> by {amount}{repeat}." },
		...
		"Stripping사용불가": { "KOR": "{actor} cannot play Stripping cards." },
		"Stripping사용불가자신": { "KOR": "You cannot play Stripping cards." },
		...
		"Stripping강제사용": { "KOR": "{actor} can only play Stripping cards." },
		"Stripping강제사용자신": { "KOR": "You can only play Stripping cards." },
		...
		"Stripping비활성화": { "KOR": "Stripping cards lose their effects." },
